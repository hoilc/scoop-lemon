...
|[3proxy](https://3proxy.org/)|[0.9.8](https://3proxy.org/)|A tiny free proxy server.|
|[4dnat](https://github.com/dushixiang/4dnat)|[0.0.5](https://github.com/dushixiang/4dnat)|A DNAT tool that works on OSI Layer 4.|
|[64gram](https://64gr.am)|[1.2.7](https://64gr.am)|Unofficial Telegram Desktop with some enhancements.|
...
|[aardio](https://www.aardio.com/)|[43.19.0](http://d.aardio.com/ide/check/)|aardio 编程语言，专注于桌面软件快速开发|
...
|[abtop](https://github.com/graykode/abtop)|[0.5.3](https://github.com/graykode/abtop)|Like htop, but for AI coding agents.|
...
|[adb-explorer](https://github.com/Alex4SSB/ADB-Explorer)|[1.0.26080](https://github.com/Alex4SSB/ADB-Explorer)|An interface to ADB that allows browsing, transferring, and editing of files with ease, in a modern and fluent Windows app, built in WPF.|
...
|[akregator-nightly](https://apps.kde.org/akregator/)|[2764](https://cdn.kde.org/ci-builds/pim/akregator/master/windows/)|(Nightly Build) An RSS feed reader developed by KDE.|
...
|[aleapp](https://github.com/abrignoni/ALEAPP)|[2026.3.1](https://github.com/abrignoni/ALEAPP)|Android Logs Events And Protobuf Parser|
...
|[algolia-cli](https://www.algolia.com/doc/tools/cli)|[1.16.0](https://www.algolia.com/doc/tools/cli)|Algolia’s official CLI devtool.|
...
|[all-smi](https://github.com/lablup/all-smi)|[0.25.0](https://github.com/lablup/all-smi)|A command-line utility for monitoring GPU and NPU hardware.|
|[alloy](https://github.com/grafana/alloy)|[1.18.1](https://github.com/grafana/alloy)|Grafana Alloy is an open source OpenTelemetry Collector distribution with built-in Prometheus pipelines and support for metrics, logs, traces, and profiles.|
|[alloydb-auth-proxy](https://github.com/GoogleCloudPlatform/alloydb-auth-proxy)|[1.16.0](https://github.com/GoogleCloudPlatform/alloydb-auth-proxy)|A utility for connecting securely to your AlloyDB instances.|
...
|[alternate-textbrowser](https://www.alternate-tools.com/pages/c_textbrowser.php?lang=ENG)|[4.540](https://www.alternate-tools.com/pages/c_textbrowser_portable.php?lang=ENG)|A free text editor which can be used to edit text and HTML files.|
...
|[amtool](https://github.com/prometheus/alertmanager)|[0.34.0](https://github.com/prometheus/alertmanager)|A cli tool for interacting with the Alertmanager API.|
...
|[andcli](https://github.com/tjblackheart/andcli)|[2.8.1](https://github.com/tjblackheart/andcli)|A 2FA TUI for your shell.|
...
|[android-cli](https://developer.android.com/tools/agents/android-cli)|[1.0.15985488](https://dl.google.com/android/cli/latest/windows_x86_64/METADATA)|A command-line interface that enables you to more easily and efficiently build for Android using any tool of your choice.|
...
|[anibaka](https://github.com/AniBakaBaka/AniBaka)|[5.0.7](https://github.com/AniBakaBaka/AniBaka/releases.atom)|跨平台番剧聚合、媒体播放与弹幕客户端|
|[anich](https://anich.emmmm.eu.org/)|[1.5.21](https://anich.emmmm.eu.org/)|支持超分辨率的在线动漫弹幕APP|
...
|[animeflow](https://github.com/openAnimeFlow/AnimeFlow)|[2.2.2](https://github.com/openAnimeFlow/AnimeFlow)|一个跨平台的动漫视频播放应用，支持多数据源、支持实时视频4k超分辨率|
...
|[ansel](https://ansel.photos/)|[0.0.0+4543.g3436875bf7](https://github.com/aurelienpierreeng/ansel/releases/expanded_assets/v0.0.0)|A darktable fork minus the bloat plus some design vision.|
|[ant-browser](https://github.com/black-ant/Ant-Browser)|[1.6.0](https://github.com/black-ant/Ant-Browser)|面向多账号隔离、代理绑定和本地环境管理的指纹浏览器|
...
|[anymex](https://github.com/RyanYuuki/AnymeX)|[3.1.6](https://github.com/RyanYuuki/AnymeX/releases.atom)|A multiservice tracking client designed exclusively for managing and tracking anime and manga progress across AniList, MyAnimeList, and Simkl.|
...
|[archisteamfarm](https://github.com/JustArchiNET/ArchiSteamFarm)|[6.3.8.4](https://github.com/JustArchiNET/ArchiSteamFarm)|C# application with primary purpose of idling Steam cards from multiple accounts simultaneously.|
...
|[arity](https://arity.cc)|[0.19.1](https://arity.cc)|A language server, formatter, and linter for R.|
...
|[ark-pixel-font-10px-monospaced](https://ark-pixel-font.takwolf.com)|[2026.08.11](https://ark-pixel-font.takwolf.com)|方舟像素字体 / Ark Pixel Font，开源的泛中日韩像素字体 (10像素等宽模式)|
|[ark-pixel-font-10px-proportional](https://ark-pixel-font.takwolf.com)|[2026.08.11](https://ark-pixel-font.takwolf.com)|方舟像素字体 / Ark Pixel Font，开源的泛中日韩像素字体 (10像素比例模式)|
|[ark-pixel-font-12px-monospaced](https://ark-pixel-font.takwolf.com)|[2026.08.11](https://ark-pixel-font.takwolf.com)|方舟像素字体 / Ark Pixel Font，开源的泛中日韩像素字体 (12像素等宽模式)|
|[ark-pixel-font-12px-proportional](https://ark-pixel-font.takwolf.com)|[2026.08.11](https://ark-pixel-font.takwolf.com)|方舟像素字体 / Ark Pixel Font，开源的泛中日韩像素字体 (12像素比例模式)|
|[ark-pixel-font-16px-monospaced](https://ark-pixel-font.takwolf.com)|[2026.08.11](https://ark-pixel-font.takwolf.com)|方舟像素字体 / Ark Pixel Font，开源的泛中日韩像素字体 (16像素等宽模式)|
|[ark-pixel-font-16px-proportional](https://ark-pixel-font.takwolf.com)|[2026.08.11](https://ark-pixel-font.takwolf.com)|方舟像素字体 / Ark Pixel Font，开源的泛中日韩像素字体 (16像素比例模式)|
|[arnis](https://github.com/louis-e/arnis)|[3.1.0](https://github.com/louis-e/arnis)|Generate any location from the real world in Minecraft with a high level of detail.|
...
|[arthas](https://alibaba.github.io/arthas/en/)|[4.3.4](https://repo1.maven.org/maven2/com/taobao/arthas/arthas-packaging/maven-metadata.xml)|A Java diagnostic tool that allows developers to troubleshoot production issues for Java applications without modifying code or restarting servers.|
...
|[asc](https://asccli.sh)|[4.6.0](https://asccli.sh)|A fast, scriptable CLI for App Store Connect and Apple Ads.|
|[asfenhance](https://github.com/chr233/ASFEnhance)|[2.3.27.0](https://github.com/chr233/ASFEnhance)|Extend the function of ASF (ArchiSteamFarm), add several practical commands|
|[asfenhance-cn](https://github.com/chr233/ASFEnhance)|[2.3.27.0](https://github.com/chr233/ASFEnhance)|Extend the function of ASF (ArchiSteamFarm), add several practical commands|
...
|[aspire](https://aspire.dev)|[13.5.0](https://aspire.dev)|A multi-language, code-first toolchain for building, running, and deploying distributed applications.|
...
|[atlassian-cli](https://developer.atlassian.com/cloud/acli/reference/commands/)|[1.3.23-stable](https://raw.githubusercontent.com/atlassian/homebrew-acli/refs/heads/main/Formula/acli.rb)|Atlassian CLI (acli) is a command line tool to interact with Atlassian Cloud.|
|[atomgit-cli](https://atomgit.com/hust-open-atom-club/atomgit-cli)|[0.7.2](https://atomgit.com/api/v5/repos/hust-open-atom-club/atomgit-cli/releases/latest)|Command-line interface for AtomGit.|
|[aube](https://aube.jdx.dev/)|[1.41.0](https://aube.jdx.dev/)|A fast Node.js package manager.|
...
|[autodarkmode](https://github.com/AutoDarkMode/Windows-Auto-Night-Mode)|[11.1.1.1](https://github.com/AutoDarkMode/Windows-Auto-Night-Mode)|Auto Dark Mode helps you switches between the dark and light theme of Windows at scheduled times.|
...
|[av1an](https://github.com/rust-av/Av1an)|[20260817-f9b14ed](https://github.com/rust-av/Av1an/releases.atom)|A cross-platform command-line AV1 / VP9 / HEVC / H264 encoding framework with per scene quality encoding.|
...
|[axiom-cli](https://axiom.co)|[0.17.0](https://axiom.co)|The CLI for Axiom, a log management and analytics solution.|
...
|[azd](https://aka.ms/azure-dev/devhub)|[1.31.1](https://azuresdkartifacts.z5.web.core.windows.net/azd/standalone/release/latest/version.txt)|A developer CLI that accelerates the time it takes for you to get started on Azure.|
...
|[azure-mcp](https://github.com/microsoft/mcp/blob/main/servers/Azure.Mcp.Server/README.md)|[3.0.0-beta.36](https://github.com/microsoft/mcp/releases.atom)|The official Azure MCP Server for AI-powered access to Azure services and resources.|
...
|[badness](https://badness.dev)|[0.16.0](https://github.com/jolars/badness/releases.atom)|A LaTeX language server, formatter, and linter.|
...
|[balabolka](https://www.cross-plus-a.com/bportable.htm)|[2.15.0.918](https://www.cross-plus-a.com/changelog.txt)|A Text-To-Speech (TTS) program uses various versions of Microsoft Speech API (SAPI).|
...
|[ballerina](https://ballerina.io/)|[2201.13.5](https://ballerina.io/downloads/)|An open-source programming language for the cloud that makes it easier to use, combine, and create network services.|
...
|[ballonstranslator](https://github.com/dmMaze/BallonsTranslator)|[1.5.11](https://github.com/dmMaze/BallonsTranslator)|深度学习辅助漫画翻译工具, 支持一键机翻和简单的图像/文本编辑 | Yet another computer-aided comic/manga translation tool powered by deeplearning.|
...
|[bbdown](https://github.com/AliverAnme/BBDown)|[1.6.16](https://github.com/AliverAnme/BBDown)|(Active Fork) A command-line downloader for Bilibili.|
...
|[beads](https://github.com/steveyegge/beads)|[1.2.2](https://github.com/steveyegge/beads)|Distributed, git-backed graph issue tracker for AI agents.|
|[beads-rust](https://github.com/Dicklesworthstone/beads_rust)|[0.3.2](https://github.com/Dicklesworthstone/beads_rust)|A Rust port of Steve Yegge's beads, frozen at the "classic" SQLite + JSONL architecture.|
...
|[benthos](https://docs.redpanda.com/redpanda-connect/about/)|[4.105.0](https://docs.redpanda.com/redpanda-connect/about/)|Redpanda Connect (Originally Benthos) is a high performance and resilient stream processor, able to connect various sources and sinks|
|[berglas](https://github.com/GoogleCloudPlatform/berglas)|[2.0.16](https://github.com/GoogleCloudPlatform/berglas)|A tool for managing secrets on Google Cloud.|
|[bestsub](https://github.com/bestruirui/BestSub)|[2.0.3](https://github.com/bestruirui/BestSub)|一个高性能的节点检测，订阅转换服务，支持多种检测项目，多种订阅格式转换，为用户提供便捷的订阅管理解决方案|
...
|[bettbox](https://github.com/appshubcc/Bettbox)|[1.18.10](https://github.com/appshubcc/Bettbox)|A network debugging and rule-based traffic splitting client powered by the Mihomo|
|[betteralign](https://github.com/dkorunic/betteralign)|[0.14.4](https://github.com/dkorunic/betteralign)|A tool that detects Go structs that would use less memory if their fields were reordered, and optionally rewrites them.|
|[betterbird](https://www.betterbird.eu/)|[153.1.0esr-bb7](https://www.betterbird.eu/)|A fine-tuned version of Mozilla Thunderbird.|
...
|[bettergi](https://bettergi.com/)|[0.63.0](https://hui-config.oss-cn-hangzhou.aliyuncs.com/bgi/notice.json)|BetterGI · 更好的原神 - UI Automation Testing Tools For Genshin Impact|
|[bettergi-alpha](https://bettergi.com/)|[0.63.2-alpha.3](https://mirrorchyan.com/api/resources/BGI/latest?user_agent=BetterGI&os=win&arch=x64&channel=alpha)|（测试版）BetterGI · 更好的原神 - UI Automation Testing Tools For Genshin Impact|
...
|[bilibili-tui](https://github.com/MareDevi/bilibili-tui)|[1.0.13](https://github.com/MareDevi/bilibili-tui)|A TUI client for Bilibili. | 一个基于终端用户界面（TUI）的 Bilibili 客户端|
|[bililite](https://github.com/ywmoyue/biliuwp-lite)|[4.8.16](https://github.com/ywmoyue/biliuwp-lite)|第三方哔哩哔哩UWP客户端|
|[bililive-go](https://github.com/bililive-go/bililive-go)|[0.8.0](https://github.com/bililive-go/bililive-go/releases.atom)|一个支持多种直播平台的直播录制工具|
...
|[binjr](https://binjr.eu)|[3.30.0](https://binjr.eu)|A standalone time series browser.|
...
|[bkviewer](http://www.bykeer.com/app/bkviewer/index.php)|[8.8d](http://www.bykeer.com/app/bkviewer/index.php)|小巧精悍的数码照片浏览器|
|[bkviewer-pro](http://www.bykeer.com/app/bkviewer/index.php)|[8.8d](http://www.bykeer.com/app/bkviewer/index.php)|(PRO版本)小巧精悍的数码照片浏览器|
...
|[blogr](https://github.com/bahdotsh/blogr)|[0.5.1](https://crates.io/api/v1/crates/blogr-cli?include=default_version)|A tool to write, edit, and publish blogs from the terminal.|
|[bluefish](https://bluefish.openoffice.nl/)|[2.4.2](https://www.bennewitz.com/bluefish/stable/binaries/windows_x64/)|A powerful editor targeted towards programmers and webdevelopers.|
...
|[bluemap-cli](https://bluemap.bluecolored.de/)|[5.23](https://bluemap.bluecolored.de/)|A Minecraft mapping tool that creates 3D models of your Minecraft worlds and displays them in a web viewer.|
...
|[bosh-cli](https://bosh.io/docs/cli-v2/)|[7.10.9](https://bosh.io/docs/cli-v2/)|The command line tool used for interacting with all things BOSH, from deployment operations to software release management.|
|[boxplayer](https://github.com/gaozhangmin/boxplayer)|[5.0.21](https://github.com/gaozhangmin/boxplayer/releases.atom)|小白羊网盘 BoxPlayer - 多网盘统一管理 + 智能媒体库 + 媒体服务器 + 高速下载|
|[braintrust-cli](https://www.braintrust.dev/docs/reference/cli/quickstart)|[0.16.2](https://www.braintrust.dev/docs/reference/cli/quickstart)|The command-line interface for Braintrust, an active observability platform for instrumenting, understanding, and improving agents.|
...
|[brutus](https://github.com/praetorian-inc/brutus)|[1.13.0](https://github.com/praetorian-inc/brutus)|A modern credential testing tool written in pure Go for brute forcing SSH, MySQL, PostgreSQL, Redis, MongoDB, SMB, and 20+ protocols.|
...
|[buck2](https://buck2.build)|[2026-08-01](https://github.com/facebook/buck2/releases.atom)|A fast, hermetic, multi-language build system, and a direct successor to the original Buck build system ("Buck1").|
|[budget-tracker-tui](https://github.com/Feromond/budget_tracker_tui)|[1.4.1](https://github.com/Feromond/budget_tracker_tui)|A TUI budget tracker app built in Rust to track income and expenses and visualize insights from your transactions.|
...
|[buildkite](https://github.com/barnybug/cli53)|[3.55.0](https://github.com/barnybug/cli53)|The command line interface for Buildkite, a scale-out delivery platform.|
...
|[buzz-captions](https://github.com/chidiwilliams/buzz)|[1.4.4](https://github.com/chidiwilliams/buzz)|Transcribe and translate audio offline on your personal computer. | 在个人电脑上离线转录和翻译音频|
|[c_cleaner_plus](https://ccs.cxs.lat)|[0.7.7](https://ccs.cxs.lat)|面向 Windows 的全盘清理工具，覆盖常规清理、大文件扫描、更多清理、应用强力卸载、定时任务和规则商店等常见场景|
|[cadabra](https://cadabra.science)|[2.5.14](https://cadabra.science)|A field-theory motivated approach to computer algebra.|
|[caido](https://www.caido.io/)|[0.57.1](https://www.caido.io/)|Caido aims to help security professionals and enthusiasts audit web applications with efficiency and ease.|
...
|[categraf](https://github.com/flashcatcloud/categraf)|[0.5.17](https://github.com/flashcatcloud/categraf)|One-stop telemetry collector for nightingale / prometheus / m3db / victoriametrics / thanos / influxdb / tdengine.|
...
|[catsxp](https://www.catsxp.com)|[6.8.3](https://www.catsxp.com)|猫眼浏览器是一款以简约安全为目标Chrome内核增强版浏览器|
...
|[cc-switch-cli](https://github.com/SaladDay/cc-switch-cli)|[5.10.2](https://github.com/SaladDay/cc-switch-cli)|An all-in-one CLI assistant for Claude Code, Codex, and Gemini CLI.|
|[ccode](https://yubsoft.com/ccode/)|[2.3](https://yubsoft.com/ccode/changelog.html)|A free source code editor based on Scintilla.|
|[ccusage](https://ccusage.com/)|[20.0.20](https://registry.npmjs.org/ccusage/latest)|Analyze coding (agent) CLI token usage and costs from local data.|
...
|[cdncheck](https://github.com/projectdiscovery/cdncheck)|[1.2.49](https://github.com/projectdiscovery/cdncheck)|A utility to detect various technology for a given IP address.|
...
|[cdxgen](https://cyclonedx.github.io/cdxgen/)|[13.0.1](https://cyclonedx.github.io/cdxgen/)|CycloneDX Generator is a CLI tool to create a valid and compliant CycloneDX Bill of Materials (BOM).|
...
|[cf-terraforming](https://github.com/cloudflare/cf-terraforming)|[0.28.0](https://github.com/cloudflare/cf-terraforming)|A command line utility to facilitate terraforming your existing Cloudflare resources.|
...
|[chainsaw](https://github.com/WithSecureLabs/chainsaw)|[2.16.4](https://github.com/WithSecureLabs/chainsaw)|Rapidly search and hunt through Windows forensic artefacts.|
...
|[checkstyle](https://checkstyle.org/cmdline.html)|[14.0.0](https://github.com/checkstyle/checkstyle/releases/latest)|A development tool to help programmers write Java code that adheres to a coding standard.|
|[cherry-studio](https://cherry-ai.com/)|[2.0.8](https://cherry-ai.com/)|🍒 Cherry Studio is a desktop client that supports for multiple LLM providers|
...
|[chrome-plus](https://github.com/Bush2021/chrome_plus)|[1.18.2](https://github.com/Bush2021/chrome_plus)|Chrome++ Next is a DLL hijack that enables full Chrome portability and tab enhancements.|
...
|[chsrc](https://github.com/RubyMetric/chsrc)|[0.2.6](https://github.com/RubyMetric/chsrc)|A command line tool to change source for every software on every platform.|
...
|[cilium-cli](https://github.com/cilium/cilium-cli)|[0.19.7](https://github.com/cilium/cilium-cli)|A CLI to install, manage & troubleshoot Kubernetes clusters running Cilium.|
...
|[clarinet](https://github.com/stx-labs/clarinet)|[3.23.1](https://github.com/stx-labs/clarinet)|A command line tool which is designed to write, test and deploy high-quality smart contracts to the Stacks blockchain and Bitcoin.|
|[clash-nyanpasu-nightly](https://nyanpasu.elaina.moe/)|[2.0.0-alpha+f2636a8](https://github.com/libnyanpasu/clash-nyanpasu/releases/expanded_assets/pre-release)|An opinionated Clash GUI based on Tauri.|
|[clash-rs](https://github.com/Watfaq/clash-rs)|[0.10.8](https://github.com/Watfaq/clash-rs)|A custom protocol, rule based network proxy software.|
...
|[clashmi](https://clashmi.app/)|[1.0.28.1406](https://clashmi.app/)|又一款mihomo核心的代理工具|
...
|[claurst](https://claurst.kuber.studio/)|[0.1.7](https://claurst.kuber.studio/)|An agentic coding CLI for builders who ship.|
...
|[clickpaste](https://github.com/Collective-Software/ClickPaste)|[1.4.4](https://github.com/Collective-Software/ClickPaste)|An application that can paste clipboard contents as keystrokes to whatever location you click.|
...
|[clippi](https://github.com/Ruszero01/clippi)|[0.4.3](https://github.com/Ruszero01/clippi)|轻量化剪贴板管理工具，使用 Rust + GPUI 构建 | Lightweight clipboard manager built with Rust and GPUI.|
...
|[cloudprober](https://cloudprober.org/)|[0.14.4](https://cloudprober.org/)|An active monitoring software to detect failures before your customers do.|
|[cloudquery](https://cloudquery.io/)|[6.41.1](https://raw.githubusercontent.com/cloudquery/cloudquery/refs/heads/main/.release-please-manifest.json)|The open source high performance ELT framework powered by Apache Arrow.|
|[clusterctl](https://cluster-api.sigs.k8s.io/)|[1.14.0](https://cluster-api.sigs.k8s.io/)|CLI tool handles the lifecycle of a Cluster API management cluster.|
...
|[cnspec](https://github.com/mondoohq/cnspec)|[13.35.2](https://github.com/mondoohq/cnspec/releases.atom)|An open source, cloud-native security to protect everything from build to runtime|
...
|[codanna](https://github.com/bartolli/codanna)|[0.13.2](https://github.com/bartolli/codanna)|Code intelligence system with semantic search.|
...
|[codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp)|[0.10.8](https://github.com/DeusData/codebase-memory-mcp)|A fast and efficient code intelligence engine for AI coding agents.|
...
|[codefresh-cli](https://codefresh-io.github.io/cli/)|[1.2.5](https://codefresh-io.github.io/cli/)|A full and flexible interface to interact with Codefresh.|
...
|[codenomad](https://github.com/NeuralNomadsAI/CodeNomad)|[0.18.0](https://github.com/NeuralNomadsAI/CodeNomad)|CodeNomad transforms OpenCode from a terminal tool into a premium desktop workspace.|
...
|[codexplusplus](https://github.com/BigPizzaV3/CodexPlusPlus)|[1.2.49](https://github.com/BigPizzaV3/CodexPlusPlus)|An enhanced tool for CodexApp, striving to make Codex better to use and more comfortable.|
...
|[comigo-desktop](https://github.com/yumenaka/comigo)|[1.3.3](https://github.com/yumenaka/comigo)|(Desktop Version) A simple and efficient comic reader.|
|[comigo-tray](https://github.com/yumenaka/comigo)|[1.3.3](https://github.com/yumenaka/comigo)|(Tray Version) A simple and efficient comic reader.|
...
|[component-detection](https://github.com/microsoft/component-detection)|[7.1.11](https://github.com/microsoft/component-detection)|Scans your project to determine what components you use.|
...
|[concord](https://github.com/chojs23/concord)|[2.5.11](https://github.com/chojs23/concord)|A feature-rich TUI client for Discord.|
...
|[cookcli](https://cooklang.org/)|[0.33.1](https://cooklang.org/)|A command line program which provides a suite of tools to create shopping lists and maintain recipes with Cooklang.|
...
|[copybara](https://github.com/google/copybara)|[20260727](https://github.com/google/copybara)|A tool for transforming and moving code between repositories.|
...
|[copyparty](https://github.com/9001/copyparty)|[1.20.21](https://github.com/9001/copyparty)|Portable file server with accelerated resumable uploads, dedup, WebDAV, FTP, TFTP, zeroconf, media indexer, thumbnails++ all in one file, no deps.|
...
|[couchbase-shell](http://couchbase.sh/)|[1.4.0](http://couchbase.sh/)|Couchbase Shell (cbsh) is a modern, productive and fun shell for Couchbase Server and Cloud.|
...
|[cpc](https://github.com/probablykasper/cpc)|[5.0.0](https://github.com/probablykasper/cpc)|A text calculator with support for units and conversion.|
...
|[credhub-cli](https://github.com/cloudfoundry/credhub-cli)|[2.9.59](https://github.com/cloudfoundry/credhub-cli)|CredHub CLI provides a command line interface to interact with CredHub servers.|
|[crossmacro](https://github.com/alper-han/CrossMacro)|[1.3.1](https://github.com/alper-han/CrossMacro)|A cross-platform desktop automation app for recording, editing, scheduling, and replaying mouse/keyboard workflows.|
|[crosspaste](https://crosspaste.com/)|[2.1.7.2461](https://crosspaste.com/)|A universal pasteboard across devices.|
|[crossplane-cli](https://docs.crossplane.io/latest/cli/)|[2.3.4](https://docs.crossplane.io/latest/cli/)|The Crossplane CLI helps simplify some development and administration aspects of Crossplane.|
|[crowdin-cli](https://crowdin.github.io/crowdin-cli/)|[4.15.0](https://crowdin.github.io/crowdin-cli/)|A command-line client for the Crowdin API.|
...
|[crush](https://github.com/charmbracelet/crush)|[0.90.0](https://github.com/charmbracelet/crush)|A powerful terminal-based AI assistant for developers, providing intelligent coding assistance directly in your terminal.|
...
|[csskit](https://csskit.rs/)|[0.0.29](https://csskit.rs/)|A high-performance CSS toolchain written in Rust, inspired by oxc.|
...
|[ctr-makerom](https://github.com/3DSGuy/Project_CTR/blob/master/makerom/README.md)|[0.19.0](https://github.com/3DSGuy/Project_CTR/releases.atom)|A CLI tool to create CTR (Nintendo 3DS) ROM images.|
|[ctrtool](https://github.com/3DSGuy/Project_CTR/blob/master/ctrtool/README.md)|[1.3.0](https://github.com/3DSGuy/Project_CTR/releases.atom)|A general purpose reading/extraction tool for Nintendo 3DS file formats.|
...
|[cue](https://cuelang.org/)|[0.17.1](https://cuelang.org/)|An open source data constraint language which aims to simplify tasks involving defining and using data.|
|[curl-impersonate](https://github.com/lexiforest/curl-impersonate)|[2.1.0](https://github.com/lexiforest/curl-impersonate)|An active fork of curl-impersonate with more versions and build targets. A series of patches that make curl requests look like Chrome, Firefox and Safari.|
...
|[cvc5-nightly](https://cvc5.github.io/)|[2026-08-19-c46a4b3](https://github.com/cvc5/cvc5/releases/expanded_assets/latest)|(Nightly Build) An efficient open-source automatic theorem prover for Satisfiability Modulo Theories (SMT) problems.|
...
|[cyclonedx-cli](https://cyclonedx.org/)|[0.33.1](https://cyclonedx.org/)|CycloneDX CLI tool for SBOM analysis, merging, diffs and format conversions.|
...
|[dalfox](https://github.com/hahwul/dalfox)|[3.2.1](https://github.com/hahwul/dalfox)|A powerful open-source XSS scanner and utility focused on automation.|
...
|[dapr](https://github.com/dapr/cli)|[1.18.1](https://github.com/dapr/cli)|The command-line tools for Dapr, which allows you to setup Dapr on your local dev machine or on a Kubernetes cluster, provides debugging support, launches and manages Dapr instances.|
...
|[dash-mpd-cli](https://emarsden.github.io/dash-mpd-cli/)|[0.2.34](https://emarsden.github.io/dash-mpd-cli/)|A commandline application for downloading media content from a DASH MPD file.|
|[dashlane-cli](https://cli.dashlane.com/)|[6.2633.2](https://cli.dashlane.com/)|A command line interface for Dashlane.|
|[data-api-builder](https://aka.ms/dab/docs)|[2.1.0-rc](https://github.com/Azure/data-api-builder/releases.atom)|Data API builder (DAB) is an open-source, no-code tool that creates secure, full-featured REST and GraphQL endpoints for your database.|
|[databricks-cli](https://docs.databricks.com/en/dev-tools/cli/index.html)|[1.12.1](https://docs.databricks.com/en/dev-tools/cli/index.html)|A tool to automate the Databricks platform from your terminal, command prompt, or automation scripts.|
|[datadog-pup](https://github.com/DataDog/pup)|[1.12.0](https://github.com/DataDog/pup)|A CLI companion for AI agents with 200+ commands across 33+ Datadog products.|
|[dataflare](https://dataflare.app/)|[3.1.9](https://assets.dataflare.app/release/windows/x86_64/latest.json)|Easily connect to your PostgreSQL, MySQL, MSSQL, SQLite databases, manage Table and execute Query.|
|[datafusion-cli](https://datafusion.apache.org/)|[55.0.0](https://crates.io/api/v1/crates/datafusion-cli?include=default_version)|DataFusion CLI is an interactive command-line utility for executing SQL queries against any supported data files.|
|[datui](https://github.com/derekwisong/datui)|[0.2.56](https://github.com/derekwisong/datui)|A high-performance terminal UI for exploring and analyzing tabular datasets.|
|[dbgate](https://dbgate.org/)|[7.2.5](https://dbgate.org/)|(Community Edition) A database manager for MySQL, PostgreSQL, SQL Server, MongoDB, SQLite and others.|
|[dblab](https://github.com/danvergara/dblab)|[0.48.1](https://github.com/danvergara/dblab)|An interactive client for PostgreSQL, MySQL and SQLite3.|
...
|[dbx](https://github.com/t8y2/dbx)|[0.5.88](https://github.com/t8y2/dbx)|A lightweight database client with support for MySQL, PostgreSQL, Redis, MongoDB, DuckDB, ClickHouse, SQL Server, and more.|
...
|[dedao-dl](https://github.com/yann0917/dedao-dl)|[1.2.27](https://github.com/yann0917/dedao-dl)|得到 APP 课程下载工具，可在终端查看文章内容，可生成 PDF，音频文件，markdown 文稿|
|[deepchat](https://deepchat.thinkinai.xyz/)|[1.1.0](https://deepchat.thinkinai.xyz/)|A feature-rich open-source AI chat platform with powerful search enhancement and tool calling capabilities.|
...
|[deja-vu](https://github.com/vshulcz/deja-vu)|[0.17.3](https://github.com/vshulcz/deja-vu)|Memory layer for coding agents: search, MCP recall, auto-context, secret redaction, stats, share and sync over the session logs Claude Code, Codex and opencode already write.|
...
|[dependabot-cli](https://github.com/dependabot/cli)|[1.92.0](https://github.com/dependabot/cli)|A tool for testing and debugging Dependabot update jobs.|
...
|[detect-it-easy-beta](https://github.com/horsicq/Detect-It-Easy)|[4.0.0-20260819](https://github.com/horsicq/DIE-engine/releases/expanded_assets/Beta)|(BETA Version) Detect It Easy (DiE) is a powerful tool for file type identification.|
...
|[devolutions-launcher](https://devolutions.net/launcher/)|[2026.2.17.0](https://devolutions.net/launcher/download/)|The remote connection launching tool for Devolutions Server & Devolutions Hub Business.|
|[devolutions-remote-desktop-manager-free](https://devolutions.net/remote-desktop-manager/)|[2026.2.17.0](https://devolutions.net/remote-desktop-manager/download/)|(Solo Edition) A remote connection management software for individual, MSPs, and IT professionals.|
|[devproxy](https://aka.ms/devproxy)|[3.2.0](https://aka.ms/devproxy)|Simulate API failures, throttling, and chaos from your command line.|
|[devtunnel](https://aka.ms/devtunnels/docs)|[1.0.2030+fc9273aa0f](https://tunnelsassetsprod.blob.core.windows.net/cli/cli-version.json)|Microsoft Dev Tunnels provides developers secure tunnels to share local web services.|
|[dezoomify-rs](https://github.com/lovasoa/dezoomify-rs)|[2.18.1](https://github.com/lovasoa/dezoomify-rs)|Zoomable image downloader for Google Arts & Culture, Zoomify, IIIF, and others.|
...
|[diesel-cli](https://diesel.rs/)|[2.3.12](https://diesel.rs/)|A safe, extensible ORM and Query Builder for Rust.|
...
|[diffractor](https://diffractor.com/)|[1.27.1](https://diffractor.com/)|A free, high-performance photo and video organizer for Windows.|
...
|[dioxus-cli](https://dioxuslabs.com/)|[0.7.10](https://dioxuslabs.com/)|A tool for getting Dioxus projects up and running.|
...
|[dismtools](https://github.com/CodingWonders/DISMTools)|[0.8_upd1](https://github.com/CodingWonders/DISMTools/releases.atom)|A front-end for DISM that lets you manage your Windows Imaging (WIM) files and a whole lot more.|
...
|[dlss-updater](https://github.com/Recol/DLSS-Updater)|[4.6.3](https://github.com/Recol/DLSS-Updater)|Update all the DLSS/XeSS DLLs for the games detected on your system.|
|[dmpro](https://cy-email.com/)|[6.26.8.16](https://cy-email.com/)|A fully-featured and reliable e-mail client.|
...
|[dnscontrol](https://stackexchange.github.io/dnscontrol/)|[4.46.0](https://stackexchange.github.io/dnscontrol/)|Synchronize your DNS to multiple providers from a simple DSL.|
|[dnsproxy](https://github.com/AdguardTeam/dnsproxy)|[0.84.1](https://github.com/AdguardTeam/dnsproxy)|A simple DNS proxy server that supports all existing DNS protocols including DNS-over-TLS, DNS-over-HTTPS, DNSCrypt, and DNS-over-QUIC.|
...
|[dockit](https://dockit.geekfun.club/)|[1.4.2](https://dockit.geekfun.club/)|A modern GUI clients for Elasticsearch, OpenSearch and etc.|
...
|[dorion](https://spikehd.github.io/projects/dorion/)|[6.13.0](https://spikehd.github.io/projects/dorion/)|A tiny alternative Discord client with a smaller footprint, themes, plugins.|
...
|[douyin](https://www.douyin.com/)|[8.4.0](https://www.douyin.com/downloadpage/pc)|抖音是一款可在智能手机上浏览的短视频社交应用程序|
|[drawio](https://www.diagrams.net/)|[31.1.8](https://www.diagrams.net/)|A diagramming app for making flowcharts, process diagrams, org charts, UML, ER and network diagrams.|
...
|[dsc](https://github.com/PowerShell/DSC)|[3.2.3](https://github.com/PowerShell/DSC)|Microsoft's Desired State Configuration is an open source command line application that abstracts the management of software components declaratively and idempotently.|
...
|[dstask](https://github.com/naggie/dstask)|[1.0.1](https://github.com/naggie/dstask)|A git powered terminal-based todo and note manager.|
...
|[duckling](https://github.com/l1xnan/duckling)|[0.59.0](https://github.com/l1xnan/duckling)|A fast viewer for CSV/Parquet files and databases such as DuckDB, SQLite, PostgreSQL, MySQL, Clickhouse, etc.|
...
|[dusklight](https://twilitrealm.dev)|[1.4.1](https://twilitrealm.dev)|A reverse-engineered reimplementation of Twilight Princess, providing new options, enhancements, and tools to customize your experience.|
...
|[earthbuild](https://www.earthbuild.dev/)|[0.8.18](https://www.earthbuild.dev/)|A simple build framework with fast, repeatable builds and a familiar syntax.|
...
|[easylpac](https://github.com/creamlike1024/EasyLPAC)|[0.8.0.3](https://github.com/creamlike1024/EasyLPAC)|A GUI frontend for lpac, the eSIM Local Profile Assistant.|
...
|[ec](https://github.com/chojs23/ec)|[0.3.3](https://github.com/chojs23/ec)|easy-conflict is a 3-way terminal-native Git merge conflict resolver.|
|[echosync](https://www.luminescence-software.org/en/echosync/about/)|[9.0.1.3](https://api.luminescence-software.org/get_latest_version.php?software=echosync)|A simple and fast software for differential file synchronization.|
...
|[edgevpn](https://mudler.github.io/edgevpn)|[0.35.4](https://mudler.github.io/edgevpn)|An immutable, decentralized, statically built P2P VPN without any central server and automatic discovery.|
...
|[editorconfig-checker](https://github.com/editorconfig-checker/editorconfig-checker)|[3.11.1](https://github.com/editorconfig-checker/editorconfig-checker)|A tool to verify that your files are in harmony with your .editorconfig.|
...
|[egctl](https://gateway.envoyproxy.io/)|[1.9.0](https://gateway.envoyproxy.io/)|A command-line tool for operating Envoy Gateway.|
...
|[emmylua_check](https://github.com/EmmyLuaLs/emmylua-analyzer-rust)|[0.25.1](https://github.com/EmmyLuaLs/emmylua-analyzer-rust)|A command-line tool for checking lua code.|
|[emmylua_doc_cli](https://github.com/EmmyLuaLs/emmylua-analyzer-rust)|[0.25.1](https://github.com/EmmyLuaLs/emmylua-analyzer-rust)|A command-line tool for generating lua documentation.|
|[emmylua_ls](https://github.com/EmmyLuaLs/emmylua-analyzer-rust)|[0.25.1](https://github.com/EmmyLuaLs/emmylua-analyzer-rust)|A language server for emmylua.|
...
|[entire](https://entire.io)|[0.10.2](https://entire.io)|A CLI that hooks into your Git workflow to capture and index AI agent sessions alongside commits.|
...
|[eudic](https://www.eudic.net/v4/en/app/eudic)|[26.8.1](https://raw.githubusercontent.com/hoilc/scoop-juicer/main/manifests/eudic/state.json)|欧路词典是一款英语词典软件，支持学习笔记、生词本多平台同步，让你随时随地学英语|
...
|[exeinfo-pe](http://www.exeinfo.xn.pl/)|[0.0.9.9](https://github.com/ExeinfoASL/ASL)|Packer, compressor detector / unpack info / internal exe tools.|
...
|[expert-lsp](https://www.expert-lsp.org)|[0.1.8](https://www.expert-lsp.org)|Official Elixir Language Server Protocol implementation.|
...
|[fabric-ai](https://github.com/danielmiessler/fabric)|[1.4.470](https://github.com/danielmiessler/fabric)|An open-source framework for augmenting humans using AI.|
...
|[fairwinds-polaris](https://www.fairwinds.com/polaris)|[10.2.2](https://www.fairwinds.com/polaris)|An open source policy engine for Kubernetes that validates and remediates resource configuration.|
...
|[fanbox-dl](https://github.com/hareku/fanbox-dl)|[0.29.1](https://github.com/hareku/fanbox-dl)|A command-line program that downloads media of supported and followed creators on Pixiv FANBOX.|
...
|[fastchess](https://github.com/Disservin/fastchess)|[1.8.2-alpha](https://github.com/Disservin/fastchess/releases.atom)|A versatile command-line tool designed for running chess engine tournaments.|
...
|[fastflowlm](https://fastflowlm.com/)|[1.0.2](https://fastflowlm.com/)|Run LLMs on AMD Ryzen™ AI NPUs in minutes.|
...
|[fastly-cli](https://fastly.dev/reference/cli/)|[16.0.0](https://fastly.dev/reference/cli/)|A CLI for interacting with the Fastly platform.|
|[fatou](https://fatou.dev)|[0.15.0](https://fatou.dev)|A language server, formatter, and linter for Julia that never has to run Julia itself.|
...
|[fcast-receiver](https://fcast.org/)|[3.0.3](https://github.com/futo-org/fcast/releases.atom)|A working receiver implementation for FCast, an open source protocol for audio and video content streaming.|
|[fcast-sender](https://fcast.org/)|[0.0.3-beta](https://github.com/futo-org/fcast/releases.atom)|Mirror your screen or system audio, videos, music or pictures to your external device running an FCast receiver.|
...
|[feedr](https://github.com/bahdotsh/feedr)|[0.8.0](https://github.com/bahdotsh/feedr)|A feature-rich terminal-based RSS/Atom feed reader written in Rust.|
|[feiq](http://www.feiq18.com/)|[<i>3.0.0.2</i>](http://www.feiq18.com/)|飞秋(FeiQ)是一款绿色免费的局域网聊天软件，兼容飞鸽传书(IPMSG)协议|
|[feishin](https://github.com/jeffvli/feishin)|[1.15.1](https://github.com/jeffvli/feishin/releases/latest)|Rewrite of Sonixd, a full-featured Subsonic/Jellyfin compatible desktop music player.|
|[feishu2md](https://github.com/Wsine/feishu2md)|[2.4.5](https://github.com/Wsine/feishu2md)|一个下载飞书文档为 Markdown 文件的工具，使用 Go 语言实现|
|[feluda](https://github.com/anistark/feluda)|[1.15.0](https://crates.io/api/v1/crates/feluda?include=default_version)|Detect license usage restrictions in your project.|
...
|[ffl](https://github.com/nuwainfo/ffl)|[4.0.6](https://github.com/nuwainfo/ffl)|A command-line tool that turns any file or folder into a secure HTTPS link, allowing two computers to simply and securely transfer files using real peer-to-peer (WebRTC) connections.|
...
|[ffmpegfreeui](https://github.com/Lake1059/FFmpegFreeUI)|[6.1.36](https://github.com/Lake1059/FFmpegFreeUI)|FFmpegFreeUI（简称 3FUI）是在 Windows 上的 FFmpeg 的专业交互外壳，收录大量参数，界面美观，交互友好|
...
|[files-cli](https://developers.files.com/cli/)|[2.15.447](https://developers.files.com/cli/)|The commandline app for Files.com.|
...
|[fleetctl](https://fleetdm.com/)|[4.90.1](https://github.com/fleetdm/fleet/releases.atom)|A CLI tool for managing Fleet, an open-source platform for IT, security, and infrastructure teams.|
|[flix](https://flix.center/)|[2.2.1.121](https://scoop-lemon.tari.xyz/hosted/flix/latest.yml)|Flix 快传，像聊天一样传文件|
|[floci](https://floci.io/)|[0.2.0](https://floci.io/)|Official command-line interface for Floci — the free, open-source local cloud emulator for AWS, GCP, and Azure.|
...
|[fluentcleaner](https://github.com/builtbybel/FluentCleaner)|[26.08.01](https://github.com/builtbybel/FluentCleaner/releases.atom)|A real WinUI desktop cleaner with terminal control and multi-database support.|
|[fluentcleaner-classic](https://github.com/builtbybel/FluentCleaner)|[1.13.137](https://github.com/builtbybel/FluentCleaner/releases.atom)|A lightweight portable desktop cleaner built on .NET Framework 4.8 with Winapp2.ini and Winapp3.ini support.|
...
|[fluux-messenger](https://github.com/processone/fluux-messenger)|[0.17.2](https://github.com/processone/fluux-messenger)|A fast, modern, cross-platform XMPP client for communities and organizations.|
|[fluvio](https://www.fluvio.io/)|[0.18.1](https://www.fluvio.io/)|A streaming platform for event stream processing.|
|[flux-operator-mcp](https://fluxcd.control-plane.io/mcp/)|[0.58.1](https://fluxcd.control-plane.io/mcp/)|Flux MCP Server connects AI assistants directly to your Kubernetes clusters running Flux Operator, enabling seamless interaction through natural language.|
|[flux9s](https://flux9s.ca)|[1.0.3](https://flux9s.ca)|A K9s-inspired terminal UI for monitoring Flux resources in real-time.|
|[fluxdown](https://fluxdown.zerx.dev/)|[0.4.8-rc.2](https://github.com/zerx-lab/FluxDown/releases.atom)|A blazing fast, multi-protocol download manager. | 极速多协议下载管理器|
|[fluxdown-cli](https://fluxdown.zerx.dev/docs/en/api/cli/)|[0.4.8-rc.1](https://github.com/zerx-lab/FluxDown/releases.atom)|An aria2c-style command-line client for FluxDown. | aria2c 风格的 FluxDown 命令行客户端|
...
|[flyingmouse-format](https://github.com/LaoFeng-mouse/flyingmouse-format)|[0.6.1](https://github.com/LaoFeng-mouse/flyingmouse-format/releases.atom)|飞鼠格式是一款鼠鼠主题、可离线使用的 Windows 文件格式转换工具 | A mouse-themed, offline Windows file converter.|
...
|[fnox](https://fnox.jdx.dev/)|[1.33.1](https://fnox.jdx.dev/)|A secrets management tool that works with both encrypted secrets in git and remote cloud providers.|
...
|[fooyin-nightly](https://github.com/fooyin/fooyin)|[b5283](https://github.com/fooyin/fooyin/actions/workflows/build.yml?query=event%3Apush+is%3Asuccess+branch%3Amaster)|(Nightly Build) A customisable music player.|
...
|[frame](https://www.framegui.app)|[0.33.0](https://www.framegui.app)|A native media conversion utility built in Rust.|
...
|[freerdp](https://www.freerdp.com/)|[2051](https://ci.freerdp.com/job/freerdp-nightly-windows/api/json)|A free implementation of the Remote Desktop Protocol (RDP).|
...
|[fresh-editor](https://github.com/sinelaw/fresh)|[0.4.9](https://github.com/sinelaw/fresh)|A terminal text editor you can just use.|
|[frpmgr](https://github.com/koho/frpmgr)|[1.27.1](https://github.com/koho/frpmgr)|FRP Manager is a multi-node, graphical reverse proxy tool designed for FRP on Windows.|
...
|[fscan](https://github.com/shadow1ng/fscan)|[2.2.0](https://github.com/shadow1ng/fscan)|An intranet comprehensive scanning tool for automated vulnerability scanning.|
...
|[fstar](https://fstar-lang.org)|[2026.08.16](https://fstar-lang.org)|A proof-oriented programming language.|
...
|[fusion-lang](https://github.com/fusionlanguage/fut)|[3.3.7](https://github.com/fusionlanguage/fut/releases/latest)|Fusion is a programming language designed for implementing reusable components (libraries) for C, C++, C#, D, Java, JavaScript, Python, Swift, TypeScript and OpenCL C, all from single codebase.|
...
|[fvm](https://fvm.app/)|[4.1.4](https://fvm.app/)|Flutter Version Management: A simple CLI to manage Flutter SDK versions.|
...
|[gajim-nightly](https://gajim.org/)|[2026-08-12](https://gajim.org/downloads/snap/win/)|(Nightly Build) A free and fully featured chat app for XMPP.|
|[gam](https://github.com/GAM-team/GAM)|[7.47.07](https://github.com/GAM-team/GAM)|A command line tool that allows administrators to manage many aspects of their Google Workspace (formerly G Suite / Google Apps) Account.|
...
|[gcx](https://github.com/grafana/gcx)|[1.1.0](https://github.com/grafana/gcx)|A CLI for managing Grafana and Grafana Cloud resources, optimized for agentic usage.|
|[gdscript-formatter](https://github.com/GDQuest/GDScript-formatter)|[0.24.0](https://github.com/GDQuest/GDScript-formatter)|A faster code formatter for GDScript and Godot 4.|
|[gearboy](https://github.com/drhelius/Gearboy)|[3.8.12](https://github.com/drhelius/Gearboy)|A Game Boy / Game Boy Color / Super Game Boy emulator, debugger and embedded MCP server.|
...
|[gefyra](https://gefyra.dev/)|[2.5.4](https://gefyra.dev/)|Blazingly-fast, rock-solid, local application development with Kubernetes.|
...
|[geniex](https://github.com/qualcomm/GenieX)|[0.4.0](https://github.com/qualcomm/GenieX)|An on-device Gen AI inference runtime for Qualcomm devices.|
...
|[ggc](https://github.com/bmf-san/ggc)|[8.7.3](https://github.com/bmf-san/ggc)|A modern Git CLI tool with both traditional command-line and interactive incremental-search UI.|
|[gguf-parser](https://github.com/gpustack/gguf-parser-go)|[0.26.0](https://github.com/gpustack/gguf-parser-go)|Review/Check GGUF files and estimate the memory usage and maximum tokens per second.|
|[gh-enhance](https://github.com/dlvhdr/gh-enhance)|[0.7.0](https://github.com/dlvhdr/gh-enhance)|A terminal UI for GitHub Actions.|
|[gh-poi](https://github.com/seachicken/gh-poi)|[0.18.3](https://github.com/seachicken/gh-poi)|A GitHub CLI extension that cleans up your local branches safely.|
...
|[ghalint](https://github.com/suzuki-shunsuke/ghalint)|[1.5.6](https://github.com/suzuki-shunsuke/ghalint)|A GitHub Actions linter for security best practices.|
...
|[ghostunnel](https://github.com/ghostunnel/ghostunnel)|[1.11.2](https://github.com/ghostunnel/ghostunnel)|A simple SSL/TLS proxy with mutual authentication for securing non-TLS services.|
|[ghqr](https://microsoft.github.io/ghqr/)|[0.6.0](https://github.com/microsoft/ghqr/releases.atom)|A CLI tool that analyzes GitHub enterprises, organizations, and repositories to ensure compliance with GitHub best practices and security recommendations.|
|[ghr](https://github.com/chenyukang/ghr)|[0.9.0](https://github.com/chenyukang/ghr)|A fast terminal workspace for staying on top of GitHub.|
...
|[gif123](https://gif123.aardio.com/)|[3.4.0.0](https://github.com/aardio/Gif123/raw/main/default.aproj)|GIF 录屏工具, 可以方便地预览、并复制到剪贴板|
|[giff](https://github.com/bahdotsh/giff)|[1.2.0](https://github.com/bahdotsh/giff)|A terminal UI for git diffs with interactive rebase support.|
...
|[git-pages-cli](https://codeberg.org/git-pages/git-pages-cli)|[1.10.1](https://codeberg.org/git-pages/git-pages-cli/releases.rss)|A command-line application for publishing sites to git-pages, a static site server for use with Git forges.|
|[git-spice](https://abhinav.github.io/git-spice/)|[0.31.2](https://abhinav.github.io/git-spice/)|A tool for stacking Git branches.|
...
|[git-statuses](https://github.com/bircni/git-statuses)|[0.8.2](https://github.com/bircni/git-statuses)|A command-line tool to display the status of multiple Git repositories in a clear, tabular format.|
...
|[git-wt](https://github.com/k1LoW/git-wt)|[0.29.1](https://github.com/k1LoW/git-wt)|A Git subcommand that makes `git worktree` simple.|
...
|[gitea-mcp](https://gitea.com/gitea/gitea-mcp)|[1.6.0](https://gitea.com/api/v1/repos/gitea/gitea-mcp/tags?limit=1)|An integration plugin designed to connect Gitea with Model Context Protocol (MCP) systems.|
...
|[github-mcp-server](https://github.com/github/github-mcp-server)|[1.10.0](https://github.com/github/github-mcp-server)|GitHub's official MCP Server.|
...
|[gitlogue](https://github.com/unhappychoice/gitlogue)|[0.10.0](https://github.com/unhappychoice/gitlogue)|A cinematic Git commit replay tool for the terminal, turning your Git history into a living, animated story.|
...
|[go-car](https://github.com/ipld/go-car)|[2.17.0](https://github.com/ipld/go-car)|A Golang implementation of CAR (Content Addressed aRchive) specifications for working with CARv1 and CARv2 files.|
...
|[go-http-file-server](https://github.com/mjpclab/go-http-file-server)|[1.21.7](https://github.com/mjpclab/go-http-file-server)|A simple command line based HTTP file server to share local file system.|
...
|[go-zero](https://go-zero.dev/)|[1.10.2](https://github.com/zeromicro/go-zero/releases.atom)|goctl is the CLI for go-zero, a cloud-native Go microservices framework.|
...
|[golazo](https://thegolazo.app)|[0.32.0](https://thegolazo.app)|A minimalist terminal user interface (TUI) for following football (soccer) matches in real-time.|
...
|[goodlink](https://gitee.com/konyshe/goodlink)|[3.0.0](https://gitee.com/konyshe/goodlink/tags.atom)|简单、无中转的内网穿透|
|[goose](https://pressly.github.io/goose/)|[3.27.3](https://pressly.github.io/goose/)|A database migration tool. Supports SQL migrations and Go functions.|
...
|[gost](https://gost.run/)|[3.2.7-nightly.20260819](https://github.com/go-gost/gost/releases.atom)|GO Simple Tunnel - a simple tunnel written in golang.|
...
|[gottet](https://gottcode.org/gottet/)|[1.2.8](https://gottcode.org/gottet/)|A falling blocks game.|
...
|[gpupad](https://github.com/houmain/gpupad)|[4.3.0](https://github.com/houmain/gpupad)|A flexible GLSL and HLSL shader editor and IDE.|
...
|[graaljs-community](https://www.graalvm.org/javascript/)|[25.2.4](https://repo1.maven.org/maven2/org/graalvm/polyglot/js/maven-metadata.xml)|(Community Edition) A high-performance, ECMAScript compliant, and embeddable JavaScript runtime for Java.|
|[graalpy](https://www.graalvm.org/python/)|[25.2.4](https://repo1.maven.org/maven2/org/graalvm/polyglot/python/maven-metadata.xml)|A high-performance embeddable Python 3 runtime for Java.|
|[graalpy-community](https://www.graalvm.org/python/)|[25.2.4](https://repo1.maven.org/maven2/org/graalvm/polyglot/python/maven-metadata.xml)|(Community Edition) A high-performance embeddable Python 3 runtime for Java.|
...
|[greptime](https://greptime.com/)|[1.1.4](https://github.com/GreptimeTeam/greptimedb/releases/latest)|GreptimeDB is an open-source, cloud-native, distributed time-series database with PromQL/SQL/Python supported.|
...
|[grpc-client-cli](https://github.com/vadimi/grpc-client-cli)|[1.24.8](https://github.com/vadimi/grpc-client-cli)|A generic gRPC command line client.|
...
|[grype](https://github.com/anchore/grype)|[0.117.0](https://github.com/anchore/grype)|A vulnerability scanner for container images and filesystems.|
...
|[h5i](https://h5i.dev/)|[0.3.4](https://h5i.dev/)|A Git sidecar for teams where AI agents write code alongside humans.|
...
|[hammer-editor](https://hammer.ink/)|[3.9.1](https://hammer.ink/)|A simple tool for building stories.|
...
|[havn](https://github.com/mrjackwills/havn)|[0.3.8](https://github.com/mrjackwills/havn)|A fast configurable port scanner with reasonable defaults.|
|[hayabusa](https://github.com/Yamato-Security/hayabusa)|[4.0.0](https://github.com/Yamato-Security/hayabusa)|A sigma-based threat hunting and fast forensics timeline generator for Windows event logs.|
...
|[helix-db](https://helix-db.com/)|[3.1.1](https://helix-db.com/)|HelixDB is an open-source graph-vector database built from scratch in Rust.|
...
|[heroic](https://heroicgameslauncher.com/)|[2.22.1](https://heroicgameslauncher.com/)|Heroic Games Launcher is a native GOG and Epic Games launcher.|
|[hevi](https://github.com/Arnau478/hevi)|[1.1.0](https://github.com/Arnau478/hevi)|A hex viewer, just like xxd or hexdump.|
|[hexalate](https://gottcode.org/hexalate/)|[1.2.7](https://gottcode.org/hexalate/)|A color matching game.|
...
|[hoptodesk](https://www.hoptodesk.com/)|[1.46.28](https://raw.githubusercontent.com/hoilc/scoop-juicer/main/manifests/hoptodesk/state.json)|A free and secure remote desktop software to easily screen share, transfer files, and securely manage devices with end-to-end encryption.|
...
|[httpmaster](https://www.httpmaster.net)|[7.1.0](https://www.httpmaster.net/download)|A professional test tool for HTTP applications, with special focus on RESTful web services and web API applications.|
...
|[hyper8](https://hyper8.org/)|[1.0.1](https://hyper8.org/download.html)|A static site generator for video publishing.|
|[hyplayer](https://github.com/HyPlayer/HyPlayer)|[2.1.38.6029](https://github.com/HyPlayer/HyPlayer)|基于UWP的第三方网易云音乐播放器|
|[hypomux](https://github.com/Hypostasis-Cat/HypoMux)|[2.5.7](https://github.com/Hypostasis-Cat/HypoMux)|Windows multi-NIC bandwidth aggregator | 专为 Windows 平台打造的多网卡带宽并发聚合下载加速工具，用于在多连接下载场景中实现更稳定的带宽叠加体验|
...
|[hysteria2](https://github.com/HyNetwork/hysteria)|[2.12.1](https://github.com/apernet/hysteria/releases)|(Version 2.x) A feature-packed proxy & relay tool optimized for lossy, unstable connections.|
|[i4tools](https://www.i4.cn/pro_pc.html)|[8.58.013](https://www.i4.cn/pro_pc.html)|简单好用的多功能苹果设备管理助手。轻松备份、恢复、删除、储存、各种设备资料，一键传输您的视频、照片、音乐、通讯录、短信等各种文件，支持管理应用、照片、音乐、铃声、视频以及其他多媒体文件，为iOS用户提供智能化一键刷机、验机功能。|
|[iaito](https://github.com/radareorg/iaito)|[6.2.0](https://github.com/radareorg/iaito)|The official graphical interface for radare2, a libre reverse engineering framework.|
...
|[icm](https://github.com/rtk-ai/icm)|[0.10.61](https://github.com/rtk-ai/icm/releases.atom)|Permanent memory for AI agents as a single binary with zero dependencies and native MCP support.|
|[idescriptor](https://idescriptor.github.io)|[0.6.1](https://idescriptor.github.io)|A free, open-source, and cross-platform iDevice management tool written in Rust and Qt.|
...
|[ik-llama-cpp](https://github.com/ikawrakow/ik_llama.cpp)|[b5187-4e49d82](https://github.com/Thireus/ik_llama.cpp/releases.atom)|(Thireus's Build / CUDA 12) ik_llama.cpp is a fork of llama.cpp with better CPU and hybrid GPU/CPU performance.|
|[ik-llama-cpp-cpu](https://github.com/ikawrakow/ik_llama.cpp)|[b5187-4e49d82](https://github.com/Thireus/ik_llama.cpp/releases.atom)|(Thireus's Build / CPU AVX2) ik_llama.cpp is a fork of llama.cpp with better CPU and hybrid GPU/CPU performance.|
|[ik-llama-cpp-cuda-13](https://github.com/ikawrakow/ik_llama.cpp)|[b5187-4e49d82](https://github.com/Thireus/ik_llama.cpp/releases.atom)|(Thireus's Build / CUDA 13) ik_llama.cpp is a fork of llama.cpp with better CPU and hybrid GPU/CPU performance.|
...
|[ileapp](https://github.com/abrignoni/iLEAPP)|[2026.3.1](https://github.com/abrignoni/iLEAPP)|iOS Logs, Events, And Plist Parser|
...
|[incy](https://incy.cc/)|[3.4.2](https://github.com/INCY-DEV/incy-platforms/releases.atom)|A cross-platform proxy client built on Xray-core.|
...
|[inngest-cli](https://github.com/inngest/inngest)|[1.42.0](https://github.com/inngest/inngest)|The CLI for Inngest, the durable execution and workflow orchestration platform for serverless step functions and AI workflows.|
...
|[inso](https://docs.insomnia.rest/inso-cli/introduction)|[13.2.0-beta.0](https://github.com/Kong/insomnia/releases.atom)|A CLI for Insomnia, allows you to use Insomnia application functionality in your terminal|
...
|[ipatool](https://github.com/majd/ipatool)|[2.3.2](https://github.com/majd/ipatool)|A command-line tool that allows searching and downloading app packages (known as ipa files) from the iOS App Store.|
...
|[iroh-ssh](https://github.com/rustonbsd/iroh-ssh)|[0.2.12](https://github.com/rustonbsd/iroh-ssh)|SSH to any machine without ip, behind a NAT/firewall without port forwarding or VPN setup.|
...
|[irust](https://github.com/sigmaSd/IRust)|[1.77.1](https://github.com/sigmaSd/IRust/releases.atom)|A cross platform REPL for Rust.|
...
|[iwaratool](https://github.com/Moeary/IwaraTool)|[0.7.0](https://github.com/Moeary/IwaraTool)|An Iwara batch downloader featuring a modern Fluent-style UI. | 图形化 Iwara 视频下载器|
...
|[jaeger](https://www.jaegertracing.io/)|[2.20.0](https://www.jaegertracing.io/download/)|An open source, distributed tracing platform.|
|[jaeger-v1](https://www.jaegertracing.io/)|[<i>1.76.0</i>](https://www.jaegertracing.io/)|An open source, distributed tracing platform.|
|[jaguar](https://github.com/toitlang/jaguar)|[1.71.0](https://github.com/toitlang/jaguar)|Jaguar enables live reloading of Toit code when developing for the ESP32, a popular microcontroller.|
...
|[jar-analyzer](https://github.com/jar-analyzer/jar-analyzer)|[6.1](https://github.com/jar-analyzer/jar-analyzer)|图形化 JAR 包分析工具|
...
|[javy](https://github.com/bytecodealliance/javy)|[9.1.0](https://github.com/bytecodealliance/javy)|A JavaScript to Webassembly toolchain|
|[jaxodraw](https://jaxodraw.sourceforge.io/)|[<i>2.1-0</i>](https://jaxodraw.sourceforge.io/)|A Java program for drawing Feynman diagrams.|
...
|[jhentai](https://github.com/jiangtian616/JHenTai)|[8.0.14+328](https://api.github.com/repos/jiangtian616/JHenTai/releases)|A cross-platform manga app made for e-hentai & exhentai by Flutter.|
...
|[jjui](https://github.com/idursun/jjui)|[0.10.9](https://github.com/idursun/jjui)|Jujutsu UI is a Text User Interface (TUI) designed for interacting with the Jujutsu version control system.|
...
|[jmol](http://jmol.sourceforge.net/)|[16.4.19](https://sourceforge.net/projects/jmol/rss)|An interactive viewer for chemical structures in 3D with features for chemicals, crystals, materials and biomolecules.|
...
|[jotta-cli](https://docs.jottacloud.com/en/collections/178055-jottacloud-command-line-tool)|[0.17.176206](https://repo.jotta.us/archives/VERSION)|A command-line client for Jottacloud.|
|[jotta-cli-unstable](https://docs.jottacloud.com/en/collections/178055-jottacloud-command-line-tool)|[0.17.176171](https://repo.jotta.us/archives-unstable/VERSION)|(Unstable Branch) A command-line client for Jottacloud.|
...
|[jujutsu](https://github.com/martinvonz/jj)|[0.44.0](https://github.com/martinvonz/jj)|Jujutsu, aka jj, is a Git-compatible DVCS that is both simple and powerful.|
...
|[justnullname-quickview](https://github.com/justnullname/QuickView)|[6.31.0.0](https://github.com/justnullname/QuickView)|A fast Windows image viewer combining a borderless geek UI with GPU-accelerated Direct2D rendering and multi-threaded JXL/AVIF decoding.|
...
|[k3kcli](https://github.com/rancher/k3k)|[1.2.0-rc4](https://github.com/rancher/k3k/releases.atom)|CLI for K3K, a tool that empowers you to create and manage isolated K3s clusters within your existing Kubernetes environment.|
...
|[kache](https://github.com/kunobi-ninja/kache)|[0.14.2](https://github.com/kunobi-ninja/kache/releases.atom)|Zero-copy, content-addressed build cache for Rust and C/C++ object compiles.|
|[kaidan-nightly](https://kaidan.im/)|[6828](https://cdn.kde.org/ci-builds/network/kaidan/master/windows/)|(Nightly Build) A user-friendly and modern chat app developed by KDE.|
...
|[kargo-cli](https://kargo.io/)|[1.11.2](https://kargo.io/)|A continuous delivery and application lifecycle orchestration platform for Kubernetes.|
|[karing](https://karing.app/)|[1.2.23.2606](https://karing.app/)|A simple & powerful proxy utility, support routing rules for clash/sing-box.|
...
|[kazumi](https://kazumi.app)|[2.2.8](https://kazumi.app)|基于自定义规则的番剧采集APP，支持流媒体在线观看，支持弹幕，支持实时超分辨率|
...
|[kcl](https://kcl-lang.io/)|[0.12.8](https://github.com/kcl-lang/cli/releases/latest)|Kusion Configuration Language (KCL) is an open source constraint-based record and functional language.|
|[kcl-kafka](https://github.com/twmb/kcl)|[0.18.0](https://github.com/twmb/kcl)|A complete, pure Go command-line Kafka client for producing, consuming, administering, transactions, and ACLs.|
...
|[kctrl](https://carvel.dev/kapp-controller/)|[0.60.4](https://github.com/carvel-dev/kapp-controller/releases.atom)|A CLI tool which helps users to observe and interact custom resources surfaced by kapp-controller effectively.|
|[kdash](https://kdash.cli.rs/)|[2.1.1](https://kdash.cli.rs/)|A simple and fast dashboard for Kubernetes.|
|[kdlfmt](https://github.com/hougesen/kdlfmt)|[0.1.7](https://github.com/hougesen/kdlfmt)|A formatter for kdl documents.|
...
|[keepassxc-snapshot](https://snapshot.keepassxc.org)|[2.8.0-290022](https://snapshot.keepassxc.org)|(Snapshot Build) Community fork of KeePass|
...
|[ketch](https://chain.sh/ketch/)|[0.14.0](https://chain.sh/ketch/)|A fast, stateless CLI for web search and scrape.|
...
|[keyecho](https://github.com/ZacharyL2/KeyEcho)|[1.1.0](https://github.com/ZacharyL2/KeyEcho)|Listen to your keyboard typing and echo pleasant sounds.|
...
|[keysteer](https://dccif.github.io/KeySteer/)|[0.9.5](https://dccif.github.io/KeySteer/)|A native keyboard-driven mouse control tool.|
...
|[kf](https://kf.dev/)|[2.12.2](https://kf.dev/)|Feels like Cloud Foundry. Runs on Kubernetes.|
|[kftray](https://kftray.app/)|[0.27.30](https://kftray.app/)|A desktop app with tray integration for managing and synchronizing kubectl port-forward configurations with ease.|
|[kftui](https://kftray.app/)|[0.27.30](https://kftray.app/)|A TUI application that manages and synchronizes kubectl port-forward configurations with ease.|
...
|[ki-editor](https://ki-editor.github.io/ki-editor/)|[20260808-1741-9059eff](https://github.com/ki-editor/ki-editor/releases/tag/latest)|Multi-cursor structural editor.|
...
|[kiesel](https://kiesel.dev/)|[202608180719](https://files.kiesel.dev/?search=windows)|A small, well-rounded JS engine written in Zig.|
|[kikoplay](https://kikoplay.fun/)|[2.1.0](https://kikoplay.fun/)|A full-featured danmu player. | 全功能弹幕播放器|
|[kilho-imageconverter](https://global.kilho.net/imageconverter)|[1.6.2](https://down.kilho.net/history.json.php?app=imageconverter&lang=en)|Change image formats in one click.|
|[kilho-kalmuri](https://global.kilho.net/kalmuri)|[4.2.7](https://down.kilho.net/history.json.php?app=kalmuri&lang=en)|A program that allows you to easily capture a screen without installing it.|
|[kilho-memorycleaner](https://global.kilho.net/memorycleaner)|[2.0.2](https://down.kilho.net/history.json.php?app=memorycleaner&lang=en)|Clean your memory with one click.|
...
|[kilo](https://kilo.ai/cli)|[7.4.22](https://github.com/Kilo-Org/kilocode/releases.atom)|Kilo Code is an AI coding agent built for the terminal.|
...
|[kingfisher](https://mongodb.github.io/kingfisher/)|[1.113.0](https://mongodb.github.io/kingfisher/)|An open-source secret scanner with live validation and 1,000+ rules for mapping blast radius across your stack.|
...
|[kmymoney](https://kmymoney.org/)|[5.2-5910](https://kmymoney.org/)|A personal finance manager developed by KDE.|
|[kmymoney-nightly](https://kmymoney.org/)|[5904](https://cdn.kde.org/ci-builds/office/kmymoney/master/windows/)|(Nightly Build) A personal finance manager developed by KDE.|
...
|[koharu](https://github.com/mayocream/koharu)|[0.77.3](https://github.com/mayocream/koharu)|ML-powered manga translator, written in Rust.|
...
|[kosli](https://github.com/kosli-dev/cli)|[2.38.0](https://github.com/kosli-dev/cli/releases.atom)|A CLI client for reporting DevOps change events to Kosli and querying them.|
...
|[krr](https://github.com/robusta-dev/krr)|[1.29.0](https://github.com/robusta-dev/krr/releases.atom)|Robusta KRR (Kubernetes Resource Recommender) is a prometheus-based tool for optimizing resource allocation in Kubernetes clusters.|
...
|[ksudoku-nightly](https://apps.kde.org/ksudoku/)|[1075](https://cdn.kde.org/ci-builds/games/ksudoku/master/windows/)|(Nightly Build) A logic-based symbol placement puzzle developed by KDE.|
...
|[ku](https://github.com/bjarneo/ku)|[0.11.0](https://github.com/bjarneo/ku)|A fast, keyboard-driven Kubernetes TUI.|
|[kube-burner](https://kube-burner.github.io/kube-burner/)|[2.8.1](https://kube-burner.github.io/kube-burner/)|A Kubernetes performance and scale test orchestration framework written in golang.|
...
|[kubectl-argo-rollouts](https://argoproj.github.io/argo-rollouts/features/kubectl-plugin/)|[1.9.1](https://argoproj.github.io/argo-rollouts/features/kubectl-plugin/)|A kubectl plugin for Argo Rollouts to enrich the experience with Rollouts, Experiments, and Analysis.|
...
|[kubectl-gadget](https://inspektor-gadget.io)|[0.55.0](https://inspektor-gadget.io)|Collection of gadgets for troubleshooting Kubernetes applications using eBPF.|
...
|[kubectl-retina](https://retina.sh/)|[1.2.4](https://github.com/microsoft/retina/releases.atom)|CLI for Retina, a cloud-agnostic, open-source Kubernetes Network Observability platform.|
...
|[kubedb-cli](https://kubedb.com/docs/latest/setup/install/kubectl_plugin/)|[0.67.0-rc.0](https://github.com/kubedb/cli/releases/latest)|The kubectl plugin for KubeDB by AppsCode.|
...
|[kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server)|[0.0.66](https://github.com/containers/kubernetes-mcp-server)|A powerful and flexible Kubernetes Model Context Protocol (MCP) server implementation with support for Kubernetes and OpenShift.|
|[kubeseal](https://github.com/bitnami-labs/sealed-secrets)|[0.39.0](https://github.com/bitnami-labs/sealed-secrets/releases)|A Kubernetes tool for one-way encrypted Secrets.|
...
|[kubevpn](https://github.com/wencaiwulue/kubevpn)|[2.11.6](https://github.com/wencaiwulue/kubevpn)|A cloud native development tool that can connect to the Kubernetes network locally|
...
|[kubexporter](https://github.com/bakito/kubexporter)|[0.9.1](https://github.com/bakito/kubexporter)|A tool for exporting Kubernetes resources as YAML or JSON files.|
...
|[lap](https://github.com/julyx10/lap)|[0.3.1](https://github.com/julyx10/lap)|An offline-first photo manager for large local libraries.|
|[lark-cli](https://github.com/larksuite/cli)|[1.0.88](https://github.com/larksuite/cli)|A command-line tool for Lark/Feishu Open Platform — built for humans and AI Agents.|
...
|[leafview](https://github.com/sprout2000/leafview)|[4.3.6](https://github.com/sprout2000/leafview)|A minimalist image viewer based on Leaflet.js and Electron.|
...
|[leo-lang](https://leo-lang.org/)|[4.4.2](https://github.com/ProvableHQ/leo/releases.atom)|An imperative, statically-typed programming language built for writing private applications.|
|[lertaro](https://lertaro.github.io)|[4.6.3](https://lertaro.github.io)|A modern, high-performance local file search and productivity launcher for Windows. | 超轻量、极速、高度可扩展的 Windows 全局搜索与效率启动工具|
...
|[lfk](https://github.com/janosmiko/lfk)|[0.17.5](https://github.com/janosmiko/lfk)|A lightning-fast, keyboard-focused TUI for navigating and managing Kubernetes clusters with a three-column Miller columns layout.|
...
|[libportable](https://github.com/adonais/libportable)|[20260819-66061132](https://github.com/adonais/libportable)|Portable Runtime For Firefox.|
|[libportable-iceweasel](https://sourceforge.net/projects/libportable)|[154.0](https://sourceforge.net/projects/libportable/rss)|Portable Runtime For Iceweasel (Firefox), an independent browser derived from Firefox/Mozilla community code.|
...
|[linux-writer](https://www.diskinternals.com/linux-writer/)|[2.0](https://raw.githubusercontent.com/hoilc/scoop-juicer/main/manifests/linux-writer/state.json)|DiskInternals Linux Writer is a unique utility to read and write files on Ext4 partitions directly from Windows.|
|[liqoctl](https://liqo.io/)|[1.2.0](https://liqo.io/)|Enable dynamic and seamless Kubernetes multi-cluster topologies.|
|[lisette](https://lisette.run/)|[0.11.3](https://github.com/ivov/lisette/releases.atom)|A little language inspired by Rust that compiles to Go.|
...
|[liteparse](https://github.com/run-llama/liteparse)|[2.13.0](https://github.com/run-llama/liteparse/releases.atom)|A fast, helpful, and open-source document parser.|
...
|[llama-cpp](https://github.com/ggml-org/llama.cpp)|[b10502](https://github.com/ggml-org/llama.cpp/releases.atom)|(CPU Backend) llama.cpp enables LLM inference with minimal setup and state-of-the-art performance on a wide range of hardware.|
|[llama-cpp-adreno](https://github.com/ggml-org/llama.cpp)|[b10502](https://github.com/ggml-org/llama.cpp/releases.atom)|(OpenCL Backend for Qualcomm Adreno GPU) llama.cpp enables LLM inference with minimal setup and state-of-the-art performance on a wide range of hardware.|
|[llama-cpp-cuda](https://github.com/ggml-org/llama.cpp)|[b10502](https://github.com/ggml-org/llama.cpp/releases.atom)|(CUDA 12 Backend) llama.cpp enables LLM inference with minimal setup and state-of-the-art performance on a wide range of hardware.|
...
|[llama-cpp-cuda-13](https://github.com/ggml-org/llama.cpp)|[b10502](https://github.com/ggml-org/llama.cpp/releases.atom)|(CUDA 13 Backend) llama.cpp enables LLM inference with minimal setup and state-of-the-art performance on a wide range of hardware.|
|[llama-cpp-hip](https://github.com/ggml-org/llama.cpp)|[b10355](https://github.com/ggml-org/llama.cpp/releases.atom)|(AMD ROCm/HIP Backend) llama.cpp enables LLM inference with minimal setup and state-of-the-art performance on a wide range of hardware.|
|[llama-cpp-openvino](https://github.com/ggml-org/llama.cpp)|[b10483](https://github.com/ggml-org/llama.cpp/releases.atom)|(OpenVINO Backend) llama.cpp enables LLM inference with minimal setup and state-of-the-art performance on a wide range of hardware.|
|[llama-cpp-sycl](https://github.com/ggml-org/llama.cpp)|[b10502](https://github.com/ggml-org/llama.cpp/releases.atom)|(SYCL Backend) llama.cpp enables LLM inference with minimal setup and state-of-the-art performance on a wide range of hardware.|
|[llama-cpp-vulkan](https://github.com/ggml-org/llama.cpp)|[b10502](https://github.com/ggml-org/llama.cpp/releases.atom)|(Vulkan Backend) llama.cpp enables LLM inference with minimal setup and state-of-the-art performance on a wide range of hardware.|
|[llama-swap](https://github.com/mostlygeek/llama-swap)|[250](https://github.com/mostlygeek/llama-swap)|A light weight, transparent proxy server that provides automatic model swapping to llama.cpp's server.|
...
|[lmms-nightly](https://lmms.io/)|[1.3.0-alpha.1.1026+feec14c](https://lmms.io/)|(Nightly Build) A free, open source, multiplatform digital audio workstation.|
...
|[logcli](https://grafana.com/docs/loki/latest/getting-started/logcli/)|[3.7.6](https://grafana.com/docs/loki/latest/getting-started/logcli/)|A command-line tool that allows users to run LogQL queries against a Loki server.|
...
|[lonkero](https://lonkero.bountyy.fi/en)|[3.7.3](https://lonkero.bountyy.fi/en)|A professional-grade attack surface scanner for penetration testing.|
...
|[lovr](https://lovr.org)|[0.19.0](https://lovr.org)|A simple Lua framework for rapidly building VR experiences.|
...
|[lspatch](https://github.com/JingMatrix/LSPatch)|[1.0](https://api.github.com/repos/JingMatrix/LSPatch/releases/latest)|A rootless Xposed framework that embeds Vector into an app by patching its APK — no root, no Zygisk.|
|[lstr](https://github.com/bgreenwell/lstr)|[0.4.0](https://github.com/bgreenwell/lstr)|A blazingly fast, minimalist directory tree viewer, written in Rust.|
|[ltspice](https://www.analog.com/en/resources/design-tools-and-calculators/ltspice-simulator.html)|[26.0.2](https://ltspice.analog.com/download/updates.txt)|A powerful, fast and free SPICE simulator software, schematic capture and waveform viewer with enhancements and models for improving the simulation of analog circuits.|
...
|[lumis-cli](https://lumis.sh/)|[0.5.0](https://crates.io/api/v1/crates/lumis-cli?include=default_version)|CLI for Lumis, a syntax highlighter powered by Tree-sitter and Neovim themes.|
|[lunatranslator](https://github.com/HIllya51/LunaTranslator)|[10.16.3.6](https://github.com/HIllya51/LunaTranslator)|LunaTranslator is a Visual Novel translate tool, support clipboard / OCR/ HOOK, support 40+ translate engines.|
...
|[mado](https://github.com/akiomik/mado)|[0.3.1](https://github.com/akiomik/mado)|A fast Markdown linter written in Rust.|
|[maestro](https://docs.maestro.dev/)|[2.8.0](https://github.com/mobile-dev-inc/Maestro/releases/latest)|A simple and effective UI testing framework for Mobile and Web.|
...
|[mago](https://mago.carthage.software/)|[1.47.2](https://github.com/carthage-software/mago/releases.atom)|An extremely fast PHP linter, formatter, and static analyzer, written in Rust.|
...
|[mangayomi](https://github.com/kodjodevf/mangayomi)|[0.8.6](https://github.com/kodjodevf/mangayomi)|An open-source Flutter app for reading manga, novels, and watching animes.|
|[mangodisk](https://mangodisk.app/)|[1.0.4](https://mangodisk.app/)|A safety-first disk cleaner and disk space analyzer.|
...
|[maple-mono](https://github.com/subframe7536/Maple-font)|[8.0-beta.1](https://github.com/subframe7536/Maple-font/releases.atom)|Open source monospace font with round corner for IDE and command line.|
|[maple-mono-hinted](https://github.com/subframe7536/Maple-font)|[8.0-beta.1](https://github.com/subframe7536/Maple-font/releases.atom)|(For Low Resolution Screen) Open source monospace font with round corner for IDE and command line.|
...
|[maple-mono-nf](https://github.com/subframe7536/Maple-font)|[8.0-beta.1](https://github.com/subframe7536/Maple-font/releases.atom)|Open source monospace/nerd font with round corner for IDE and command line.|
|[maple-mono-nf-cn](https://github.com/subframe7536/Maple-font)|[8.0-beta.1](https://github.com/subframe7536/Maple-font/releases.atom)|开源圆角的等宽和控制台字体|
|[maple-mono-nf-cn-hinted](https://github.com/subframe7536/Maple-font)|[8.0-beta.1](https://github.com/subframe7536/Maple-font/releases.atom)|（1080P及以下分辨率适用）开源圆角的等宽和控制台字体|
|[maple-mono-nf-hinted](https://github.com/subframe7536/Maple-font)|[8.0-beta.1](https://github.com/subframe7536/Maple-font/releases.atom)|(For Low Resolution Screen) Open source monospace/nerd font with round corner for IDE and command line.|
...
|[markpad](https://markpad.dev/)|[2.7.4](https://markpad.dev/)|A lightweight, minimalist Markdown viewer and text editor built for productivity.|
|[markra](https://markra.app/)|[2.8.0](https://markra.app/)|A local-first, open-source Markdown editor that brings AI into the writing flow.|
...
|[maxthon](https://www.maxthon.com/)|[7.5.3.1000](https://api.github.com/repos/maxthon/Maxthon/releases/latest)|A state-of-the-art,multi-platform web browser that offers users a seamless browsing and sharing experience.|
...
|[mcap](https://mcap.dev/)|[0.3.0](https://github.com/foxglove/mcap/releases)|A CLI tool for interacting with MCAP format that is a modular container format and logging library for pub/sub messages with arbitrary message serialization.|
|[mcat](https://github.com/Skardyy/mcat)|[0.6.4](https://github.com/Skardyy/mcat)|cat command for documents / images / videos and more.|
...
|[mcp-grafana](https://github.com/grafana/mcp-grafana)|[1.1.0](https://github.com/grafana/mcp-grafana)|A Model Context Protocol (MCP) server for Grafana.|
...
|[mcp-toolbox](https://mcp-toolbox.dev/)|[1.9.0](https://mcp-toolbox.dev/)|MCP Toolbox for Databases is an open source MCP server for databases.|
...
|[mdbplus](http://www.alexnolan.net/software/mdb_viewer_plus.htm)|[2.80](http://www.alexnolan.net/software/mdbplus.xml)|MDB Viewer Plus is a freeware viewer plus editor for opening Microsoft Access MDB and ACCDB database files.|
|[mdfried](https://github.com/benjajaja/mdfried)|[0.22.5](https://github.com/benjajaja/mdfried)|A markdown viewer for the terminal that renders images and big headers.|
...
|[meilisearch](https://www.meilisearch.com/)|[1.53.1](https://www.meilisearch.com/)|A powerful, fast, open-source, easy to use and deploy search engine.|
...
|[mergify-cli](https://github.com/Mergifyio/mergify-cli)|[2026.8.11.1](https://github.com/Mergifyio/mergify-cli)|The command-line tool for Mergify: stacked pull requests, CI insights, merge queue, scheduled freezes, and configuration management.|
|[mesheryctl](https://meshery.io/)|[1.0.66](https://meshery.io/)|Command-line utility for Meshery, the cloud native management plane.|
|[metabase](https://github.com/metabase/metabase)|[0.63.14](http://static.metabase.com/version-info.json)|Metabase is the easy, open source way for everyone in your company to ask questions and learn from data.|
|[metabase-ee](https://www.metabase.com/enterprise/)|[1.63.14](http://static.metabase.com/version-info-ee.json)|Metabase Enterprise Edition is the easy way for everyone in your company to ask questions and learn from data.|
...
|[metapac](https://github.com/ripytide/metapac)|[0.10.1](https://crates.io/api/v1/crates/metapac?include=default_version)|Multi-backend declarative package manager.|
...
|[mi-sans](https://hyperos.mi.com/font)|[<i>4.009</i>](https://hyperos.mi.com/font)|Mi Sans 字体笔型平直有力，设计更加简约，减少视觉负担，更有利于屏幕显示，供全社会免费商用|
...
|[microsoft-fabric-mcp](https://github.com/microsoft/mcp/blob/main/servers/Fabric.Mcp.Server/README.md)|[1.3.0](https://github.com/microsoft/mcp/releases.atom)|A local-first MCP server providing AI agents with comprehensive access to Microsoft Fabric's public APIs, item definitions, and best practices.|
|[microsoft-safety-scanner](https://learn.microsoft.com/en-us/defender-endpoint/safety-scanner-download)|[1.457.245.0](https://learn.microsoft.com/en-us/defender-endpoint/safety-scanner-download)|A scan tool designed to find and remove malware from Windows computers.|
...
|[micyou](https://github.com/LanRhyme/MicYou)|[2.0.1](https://github.com/LanRhyme/MicYou)|A powerful tool that turns your Android device into a high-quality wireless microphone for your PC.|
...
|[mieru](https://github.com/enfein/mieru)|[3.36.0](https://github.com/enfein/mieru)|A socks5 / HTTP / HTTPS proxy.|
|[minbrowser](https://minbrowser.org/)|[1.35.6](https://minbrowser.org/)|A fast, minimal browser that protects your privacy.|
|[minder](https://minder-docs.stacklok.dev/)|[0.3.1](https://minder-docs.stacklok.dev/)|An open source platform that helps development teams and open source communities build more secure software, and prove to others that what they’ve built is secure.|
...
|[minio-certgen](https://github.com/minio/certgen)|[1.4.0](https://github.com/minio/certgen)|A simple tool to generate self-signed certificates with SAN DNS and IP entries.|
|[minio-warp](https://github.com/minio/warp)|[1.6.1](https://github.com/minio/warp)|S3 benchmarking tool.|
...
|[mistralrs-cpu](https://github.com/EricLBuehler/mistral.rs)|[0.9.1](https://github.com/EricLBuehler/mistral.rs)|(CPU Backend) mistral.rs is a single binary for local inference, OpenAI-compatible serving, Anthropic-compatible Messages serving, and agentic workloads.|
|[mitec-certificate-generator](https://www.mitec.cz/wp/cg/)|[1.0.0](https://www.mitec.cz/wp/cg/)|An application that helps you to generate self-signed certificate in X509 format (pem,cer) or PKCS#12 format (pfx).|
|[mitec-certificate-information](https://www.mitec.cz/wp/mci/)|[1.5.0](https://www.mitec.cz/wp/mci/)|A tool that provides detailed information about certificates and signed files.|
|[mitec-exe-explorer](https://www.mitec.cz/wp/mee/)|[3.7.5](https://www.mitec.cz/webupdate.html)|An executable file explorer for OS/2, NE, PE32, PE32+ and VxD file types.|
|[mitec-hexedit](https://www.mitec.cz/wp/mhex/)|[7.1.0](https://www.mitec.cz/webupdate.html)|A powerful hexadecimal editor with many features.|
|[mitec-infobar](https://www.mitec.cz/wp/mib/)|[4.6.2](https://www.mitec.cz/webupdate.html)|A versatile tool not only for programmers but also for ordinary geeks.|
|[mitec-json-viewer](https://www.mitec.cz/wp/mjsonv/)|[3.2.2](https://www.mitec.cz/webupdate.html)|A full-featured JSON/BSON viewer and editor.|
|[mitec-mail-viewer](https://www.mitec.cz/wp/mmv/)|[2.5.1](https://www.mitec.cz/webupdate.html)|A viewer for Outlook Express, Windows Mail/Windows Live Mail and Mozilla Thunderbird message databases as well as single EML files.|
|[mitec-network-scanner](https://www.mitec.cz/wp/mns/)|[6.1.0](https://www.mitec.cz/webupdate.html)|A multi-threaded ICMP, Port, IP, NetBIOS/NetBT, ActiveDirectory and SNMP scanner with many advanced features.|
|[mitec-sqlite-query](https://www.mitec.cz/wp/msqliteq/)|[3.2.0](https://www.mitec.cz/webupdate.html)|A tool for SQLite3 databases administration and data manipulation.|
|[mitec-system-information-extra](https://www.mitec.cz/wp/msix/)|[16.0.0](https://www.mitec.cz/wp/msix/)|A tool that provides complex system information about your computer software and hardware environment.|
|[mitec-task-manager-deluxe](https://www.mitec.cz/wp/tmx/)|[5.0.0](https://www.mitec.cz/webupdate.html)|MiTeC Task Manager DeLuxe (TMX) is a full-featured task manager replacement that offers powerful features with many more enhancements.|
|[mitec-windows-registry-recovery](https://www.mitec.cz/wp/mwrr/)|[3.1.3](https://www.mitec.cz/webupdate.html)|A tool for crashed machine registry configuration data recovery and registry backup.|
...
|[mkbrr](https://github.com/autobrr/mkbrr)|[1.25.0](https://github.com/autobrr/mkbrr)|A powerful CLI tool to create, inspect, and modify torrent files.|
...
|[mo](https://github.com/k1LoW/mo)|[1.6.7](https://github.com/k1LoW/mo)|A Markdown viewer that opens .md files in a browser.|
...
|[moltis](https://github.com/moltis-org/moltis)|[20260818.10](https://github.com/moltis-org/moltis)|A secure persistent personal agent server in Rust.|
...
|[mongodb-atlas-cli](https://dochub.mongodb.org/core/atlas-cli)|[1.58.0](https://www.mongodb.com/try/download/atlascli)|The Atlas CLI lets you manage your MongoDB Atlas deployments from the command line.|
|[mongodb-compass](https://www.mongodb.com/products/compass)|[1.49.14](https://www.mongodb.com/try/download/compass)|The GUI for MongoDB, which allows you to make smarter decisions about document structure, querying, indexing, document validation, and more.|
|[mongodb-compass-isolated](https://www.mongodb.com/products/compass)|[1.49.14](https://www.mongodb.com/try/download/compass)|The GUI (Isolated Edition) for MongoDB, which allows you to make smarter decisions about document structure, querying, indexing, document validation, and more.|
|[mongodb-compass-readonly](https://www.mongodb.com/products/compass)|[1.49.14](https://www.mongodb.com/try/download/compass)|The GUI (Readonly Edition) for MongoDB, which allows you to make smarter decisions about document structure, querying, indexing, document validation, and more.|
|[monkeysaudio](https://monkeysaudio.com/)|[13.25](https://monkeysaudio.com/versionhistory.html)|Monkey’s Audio is a fast and easy way to compress digital music.|
...
|[moon](https://moonrepo.dev/moon)|[2.5.2](https://github.com/moonrepo/moon/releases.atom)|A build system and monorepo management tool for the web ecosystem, written in Rust.|
...
|[moonbit](https://www.moonbitlang.com/)|[20260819-eb7988b-46d9565](https://www.moonbitlang.com/)|An end-to-end programming language toolchain for cloud and edge computing using WebAssembly.|
...
|[morphe-desktop](https://github.com/MorpheApp/morphe-desktop)|[1.13.1](https://github.com/MorpheApp/morphe-desktop)|Morphe Desktop is a command-line and GUI application that uses Morphe Patcher to patch Android apps.|
...
|[mousemaster](https://github.com/petoncle/mousemaster)|[92](https://github.com/petoncle/mousemaster)|Efficiently control your mouse with keyboard inputs for a completely mouseless experience.|
...
|[mql](https://github.com/mondoohq/cnquery)|[13.35.2](https://github.com/mondoohq/cnquery/releases.atom)|A cloud-native tool for querying your entire infrastructure.|
...
|[mra](https://mra.jadquir.com/)|[0.2.1](https://downloads.mra.jadquir.com/updates.json)|A music recognition application, or music identifier, like Shazam but for PC.|
...
|[msstore-cli](https://github.com/microsoft/msstore-cli)|[0.4.0](https://github.com/microsoft/msstore-cli)|A CLI that helps developers access the Microsoft Store APIs, for both managed (MSIX), as well as unmanaged (MSI/EXE) applications.|
...
|[murmure](https://www.murmure.app/)|[1.10.1](https://www.murmure.app/)|A privacy-first, open-source speech-to-text application that runs entirely on your machine.|
...
|[mysqld_exporter](https://github.com/prometheus/mysqld_exporter)|[0.20.0](https://github.com/prometheus/mysqld_exporter)|A Prometheus exporter for MySQL server metrics.|
...
|[nak](https://github.com/fiatjaf/nak)|[0.20.6](https://github.com/fiatjaf/nak)|A command line tool for doing all things nostr.|
...
|[nattypetester](https://github.com/HMBSbige/NatTypeTester)|[10.0.7](https://github.com/HMBSbige/NatTypeTester)|A tool that tests out what your NAT type is. / 测试当前网络的 NAT 类型（STUN）|
|[nattypetester-console](https://github.com/HMBSbige/NatTypeTester)|[10.0.7](https://github.com/HMBSbige/NatTypeTester)|A commandline tool that tests out what your NAT type is. / 命令行版测试当前网络的 NAT 类型（STUN）|
...
|[nauz-file-detector-beta](https://github.com/horsicq/Nauz-File-Detector)|[1.0.0-20260818](https://github.com/horsicq/Nauz-File-Detector/releases/expanded_assets/Beta)|(BETA Version) Nauz File Detector is a portable linker/compiler/packer identifier utility.|
...
|[near-cli](https://github.com/near/near-cli-rs)|[0.30.0](https://github.com/near/near-cli-rs)|A human-friendly companion that helps to interact with NEAR Protocol from command line.|
...
|[nebula](https://github.com/slackhq/nebula)|[1.11.0](https://github.com/slackhq/nebula)|A scalable overlay networking tool with a focus on performance, simplicity and security.|
...
|[neru](https://github.com/y3owk1n/neru)|[1.51.0](https://github.com/y3owk1n/neru)|A tool to navigate your entire screen without touching the mouse.|
|[nerva](https://github.com/praetorian-inc/nerva)|[1.69.0](https://github.com/praetorian-inc/nerva)|A fast service fingerprinting CLI for 170+ protocols (TCP/UDP/SCTP).|
...
|[netcatty](https://netcatty.app/)|[1.1.81](https://github.com/binaricat/Netcatty/releases.atom)|A beautiful, feature-rich SSH workspace built with Electron, React, and xterm.js.|
...
|[netsurf-nightly](https://www.netsurf-browser.org/)|[7446](https://ci.netsurf-browser.org/builds/windows/LATEST)|A free, open source web browser.|
|[newt](https://github.com/fosrl/newt)|[1.16.0](https://github.com/fosrl/newt)|A fully user space WireGuard tunnel client for Pangolin.|
...
|[nipaplay](https://github.com/MCDFsteve/NipaPlay-Reload)|[1.11.4](https://github.com/MCDFsteve/NipaPlay-Reload)|NipaPlay-Reload 是一个现代化的跨平台视频播放器，集成了弹幕显示、多格式字幕支持、多音频轨道切换，新番查看等功能|
...
|[nordpass](https://nordpass.com/)|[7.9.5](https://downloads.npass.app/windows/latest.yml)|A password management solution for a secure digital life.|
...
|[notegen](https://github.com/codexu/note-gen/)|[0.35.1](https://github.com/codexu/note-gen/releases.atom)|A cross-platform Markdown note-taking application dedicated to using AI to bridge recording and writing, organizing fragmented knowledge into a readable note.|
...
|[nub](https://nubjs.com)|[0.7.5](https://nubjs.com)|A fast all-in-one toolkit that augments Node.js instead of replacing it.|
...
|[nyaterm](https://nyaterm.app/)|[1.2.4](https://nyaterm.app/)|A desktop terminal client for SSH, serial connections, and local command-line work.|
|[oasis](https://github.com/machengim/oasis)|[0.2.6](https://github.com/machengim/oasis)|A self-hosted file server.|
|[oauth2l](https://github.com/google/oauth2l)|[1.3.4](https://github.com/google/oauth2l)|A simple CLI for interacting with Google API authentication.|
|[objdiff](https://github.com/encounter/objdiff)|[3.8.0](https://github.com/encounter/objdiff)|A local diffing tool for decompilation projects.|
|[objdiff-cli](https://github.com/encounter/objdiff)|[3.8.0](https://github.com/encounter/objdiff)|(CLI Version) A local diffing tool for decompilation projects.|
|[objeck](https://objeck.org/)|[2026.8.2](https://objeck.org/)|A modern object-oriented programming language with functional features.|
...
|[obs-cmd](https://github.com/grigio/obs-cmd)|[1.0.1](https://github.com/grigio/obs-cmd)|A minimal OBS CLI for obs-websocket v5.|
|[obscura](https://obscura.sh)|[0.2.0](https://obscura.sh)|A headless browser for AI agents and web scraping.|
...
|[octelium-cli](https://octelium.com/docs/octelium/latest/overview/cli)|[0.39.0](https://octelium.com/docs/octelium/latest/overview/cli)|CLI for Octelium, a free and open source, self-hosted, unified zero trust secure access platform|
...
|[odigos](https://odigos.io/)|[1.35.1](https://odigos.io/)|A tool for managing odigos, an open-source observability control plane.|
...
|[omnictl](https://omni.siderolabs.com/)|[1.10.4](https://omni.siderolabs.com/)|CLI for the Sidero Omni Kubernetes management platform.|
...
|[oncepower](https://github.com/ilgnefz/once_power)|[3.2.2](https://github.com/ilgnefz/once_power)|Once Power is a tool developed based on Flutter for batch renaming files and batch moving and deleting files|
...
|[onyx-lang](https://onyxlang.io/)|[0.1.13-beta](https://github.com/onyx-lang/onyx/releases.atom)|An efficient, procedural, and pragmatic programming language.|
...
|[openbao](https://openbao.org)|[2.6.2](https://github.com/openbao/openbao/releases.atom)|An open source, community-driven fork of Vault managed by the Linux Foundation.|
...
|[opendataloader-pdf](https://opendataloader.org)|[2.5.1](https://opendataloader.org)|A PDF parser for AI-ready data extraction and accessibility automation.|
|[opengrep](https://github.com/opengrep/opengrep)|[1.27.1](https://github.com/opengrep/opengrep)|A static code analysis engine to find security issues in code.|
|[openinterpreter](http://openinterpreter.com/)|[0.0.39](https://github.com/openinterpreter/openinterpreter/releases.atom)|Open Interpreter is a coding agent optimized for low-cost models.|
|[openlogi](https://openlogi.org/)|[0.7.1](https://openlogi.org/)|A native, local-first alternative to Logitech Options+, written in Rust.|
|[openobserve](https://openobserve.ai/)|[0.92.2](https://github.com/openobserve/openobserve/releases.atom)|A cloud native observability platform built specifically for logs, metrics, traces, analytics, RUM designed to work at petabyte scale.|
...
|[openspeedy](https://github.com/game1024/OpenSpeedy)|[3.3.8](https://github.com/game1024/OpenSpeedy/releases.atom)|An open-source game speed modifier / 一款开源的游戏变速器|
...
|[ort](https://oss-review-toolkit.org/)|[92.3.0](https://oss-review-toolkit.org/)|OSS Review Toolkit (ORT) is a suite of tools to automate software compliance checks.|
|[orth](https://oss-review-toolkit.org/)|[92.3.0](https://oss-review-toolkit.org/)|A CLI helper for ort, a suite of tools to automate software compliance checks.|
...
|[otel-desktop-viewer](https://github.com/CtrlSpice/otel-desktop-viewer)|[0.4.1](https://github.com/CtrlSpice/otel-desktop-viewer)|A CLI tool for receiving OpenTelemetry traces on your local machine.|
|[otel-tui](https://github.com/ymtdzzz/otel-tui)|[0.7.4](https://github.com/ymtdzzz/otel-tui)|A terminal OpenTelemetry viewer.|
...
|[otpauth](https://github.com/dim13/otpauth)|[0.6.1](https://github.com/dim13/otpauth)|A Google Authenticator migration decoder that converts otpauth-migration://offline?data=... to plain otpauth links.|
...
|[owlplug](https://owlplug.com/)|[2.0.0](https://owlplug.com/)|A desktop application that simplifies audio plugins management and installation.|
|[oxen](https://oxen.ai/)|[0.53.4](https://oxen.ai/)|CLI for Oxen, a lightning fast data version control system for structured and unstructured machine learning datasets.|
|[oxideterm](https://oxideterm.app/)|[2.0.22](https://oxideterm.app/)|All-in-one terminal workspace — local shells, SSH, SFTP, remote IDE, AI agent, and file manager in a single native binary.|
...
|[oxvg](https://github.com/noahbald/oxvg)|[0.0.7](https://crates.io/api/v1/crates/oxvg?include=default_version)|A fast SVG toolchain for optimisation, minification, linting, and actions.|
...
|[pagefind](https://pagefind.app/)|[1.5.2](https://pagefind.app/)|A fully static search engine that aims to perform well on large sites.|
|[pagefind-extended](https://pagefind.app/)|[1.5.2](https://pagefind.app/)|A static search engine with extended language support, including CJK tokenization.|
...
|[papas-best-optimizer](https://papas-best.com/optimizer_en)|[24.05.12](https://papas-best.com/downloads/optimizer/changes.txt)|Shrinks images and documents losslessly by optimizing existing compression.|
...
|[par2](https://parchive.github.io/)|[1.3.0](https://parchive.github.io/)|par2cmdline is a PAR 2.0 compatible file verification and repair tool.|
...
|[parsync](https://github.com/AlpinDale/parsync)|[0.3.0](https://github.com/AlpinDale/parsync)|A high-throughput, resumable parallel sync tool for SSH remotes and local-to-local transfers.|
...
|[pcgen-nightly](https://github.com/PCGen/pcgen)|[6.09.08.RC1-NIGHTLY.20260819](https://github.com/PCGen/pcgen/releases.atom)|A program that help you build characters for role-playing games like Pathfinder and D&D.|
...
|[pdf-inspector](https://firecrawl.github.io/pdf-inspector/)|[1.15.0](https://crates.io/api/v1/crates/pdf-inspector?include=default_version)|A fast PDF inspection, classification, and text extraction tool.|
...
|[pdfgear](https://www.pdfgear.com/)|[2.1.19](https://www.pdfgear.com/download/)|A piece of full-featured PDF management software.|
...
|[pdx-unlimiter](https://github.com/crschnick/pdx_unlimiter)|[3.5.5](https://github.com/crschnick/pdx_unlimiter)|A smart savegame manager, editor, and toolbox for all current major Paradox Grand Strategy games.|
...
|[perses](https://perses.dev/)|[0.54.0](https://github.com/perses/perses/releases.atom)|A dashboard tool that you can use to display a variety of observability data.|
...
|[pgstream](https://github.com/xataio/pgstream)|[1.4.1](https://github.com/xataio/pgstream)|An open source CDC command-line tool that offers Postgres replication support with DDL changes to any provided target.|
|[pgtui](https://codeberg.org/kdwarn/pgtui)|[0.16.0](https://codeberg.org/kdwarn/pgtui/releases.rss)|A Postgres TUI client that handles basic CRUD operations, utilizing your terminal editor for inserts and updates.|
...
|[pikpak](https://mypikpak.com/)|[2.14.0](https://raw.githubusercontent.com/hoilc/scoop-juicer/main/manifests/pikpak/state.json)|极速秒存的私人云盘，在电脑上轻松使用|
...
|[pilotedit-lite](https://www.pilotedit.com/)|[21.1.0](https://www.pilotedit.com/)|A handy text editor you can use for working with plain text files, as well as for coding projects in a bunch of popular programming languages.|
...
|[pineapple-notepad](https://github.com/BLumia/pineapple-notepad)|[1.1.0](https://api.github.com/repos/BLumia/pineapple-notepad/releases/latest)|A Qt 6, KDE framework and scintilla-based cross-platform Notepad++ alternative.|
...
|[pingo](https://css-ig.net/pingo)|[1.29](https://css-ig.net/pingo)|An experimental lossless and lossy image optimizer (PNG, JPEG, WebP, APNG) designed to be used for web context.|
...
|[pitchfork](https://pitchfork.jdx.dev/)|[2.22.0](https://pitchfork.jdx.dev/)|A devilishly good process manager for developers.|
|[pixelflasher](https://github.com/badabing2005/PixelFlasher)|[9.1.5.0](https://github.com/badabing2005/PixelFlasher)|Pixel phone flashing GUI utility with features.|
...
|[pixi](https://pixi.sh)|[0.77.0](https://pixi.sh)|A cross-platform, multi-language package manager and workflow tool built on the foundation of the conda ecosystem.|
|[pixpin](https://pixpinapp.com/)|[3.4.3.2](https://upgrade.pixpin.cn/api/check/0/3.2.3.1/windows/x64/intl/zh-cn/.zip)|功能强大使用简单的截图/贴图工具，帮助你提高效率|
|[pixpin-beta](https://pixpinapp.com/)|[3.5.2.2](https://upgrade.pixpin.cn/api/check/1/3.4.1.3/windows/x64/intl/zh-cn/.zip)|（测试版）功能强大使用简单的截图/贴图工具，帮助你提高效率|
|[pixshell](https://github.com/lyu0805/pixshell)|[0.1.7](https://github.com/lyu0805/pixshell)|A desktop SSH / SFTP client for macOS and Windows. | 跨平台 SSH / SFTP 桌面客户端 · 终端 · 连接管理 · 文件传输|
...
|[plik-cli](https://plik.root.gg)|[1.4.2](https://github.com/root-gg/plik/releases.atom)|CLI client for Plik, a temporary file upload system.|
...
|[pode](https://badgerati.github.io/Pode/)|[2.14.0](https://badgerati.github.io/Pode/)|A cross-platform PowerShell web framework for creating REST APIs, Web Sites, and TCP/SMTP servers.|
...
|[portal-tunnel](https://gosuda.github.io/portal-tunnel/)|[2.3.7](https://gosuda.github.io/portal-tunnel/)|Publishes localhost services to the agentic web through self-hostable, trustless relays with x402 payments.|
...
|[ppee](https://mzrst.com/)|[1.14](https://mzrst.com/)|PPEE (puppy) is a Professional PE file Explorer for reversers, malware researchers and those who want to statically inspect PE files in more details.|
|[ppftpd](https://perkele.cc/software/PPFTPD)|[1.4](https://perkele.cc/software/PPFTPD)|A minimal FTP server for Microsoft Windows.|
|[pqcscan](https://github.com/anvilsecure/pqcscan)|[0.8.0](https://github.com/anvilsecure/pqcscan)|A post-quantum cryptography scanner for SSH/TLS servers.|
...
|[prek](https://github.com/j178/prek)|[0.4.14](https://github.com/j178/prek)|Better `pre-commit`, re-engineered in Rust.|
...
|[printpdf](https://printpdf.github.io)|[4.9.20](https://printpdf.github.io/version.json)|发票闪印是一款方便用于打印PDF发票的辅助工具，无需安装阅读器|
|[privacy-eraser](https://www.cybertronsoft.com/products/privacy-eraser/)|[6.30](https://www.cybertronsoft.com/download/privacy-eraser/)|Privacy Eraser is an easy to use solution for protecting your privacy by deleting your browsing history and other computer activities.|
...
|[privazer](https://privazer.com)|[4.0.125](https://privazer.com/changelog.php)|A PC cleaner & Privacy tool.|
...
|[profile-explorer](https://github.com/microsoft/profile-explorer)|[1.3.1](https://github.com/microsoft/profile-explorer)|A tool for viewing CPU profiling traces collected through the Event Tracing for Windows (ETW) infrastructure on machines with x64 and ARM64 CPUs.|
...
|[project-graph](https://github.com/LiRenTech/project-graph)|[4.2.3](https://github.com/LiRenTech/project-graph)|An open-source project that aims to provide a next-generation node diagram tool for visual thinking.|
...
|[proto](https://moonrepo.dev/proto)|[0.60.2](https://moonrepo.dev/proto)|A pluggable multi-language version manager.|
...
|[proton-pass-cli](https://protonpass.github.io/pass-cli/)|[2.3.2](https://proton.me/download/pass-cli/versions.json)|Proton Pass CLI is a command-line interface for managing your Proton Pass vaults, items, and secrets.|
...
|[pscale](https://github.com/planetscale/cli)|[0.322.0](https://github.com/planetscale/cli)|The CLI for PlanetScale Database.|
...
|[psysonic](https://www.psysonic.de/)|[1.51.0](https://github.com/Psychotoxical/psysonic/releases.atom)|A gorgeous, modern, and blazing fast Navidrome desktop client.|
...
|[pulsarctl](https://github.com/streamnative/pulsarctl)|[4.2.1.11](https://raw.githubusercontent.com/hoilc/scoop-juicer/main/manifests/pulsarctl/state.json)|A CLI for Apache Pulsar written in Go.|
...
|[pumpkin-nightly](https://pumpkinmc.org/)|[b10287-20260819-c196aa5](https://github.com/Pumpkin-MC/Pumpkin/actions/workflows/rust.yml?query=branch%3Amaster+event%3Apush+is%3Asuccess)|A Minecraft server built entirely in Rust, offering a fast, efficient, and customizable experience.|
...
|[qmmp](http://qmmp.ylsoftware.com/)|[2.4.0](http://qmmp.ylsoftware.com/downloads.php)|Qmmp (Qt-based Multimedia Player) is an audio-player whose user interface is similar to winamp or xmms.|
|[qodercli](https://qoder.com/cli)|[1.1.26](https://download.qoder.com/qodercli/channels/manifest.json)|Qoder AI CLI tool - Terminal-based AI assistant for code development.|
|[qoderclicn](https://qoder.com.cn/cli)|[1.1.26](https://static.qoder.com.cn/qoder-cli-cn/channels/manifest.json)|(国内版) Qoder CLI AI 编程助手，将强大的 AI 编程能力直接带入你的终端|
...
|[qshell](https://github.com/qiniu/qshell)|[2.19.12](https://github.com/qiniu/qshell)|Shell Tools for Qiniu Cloud.|
...
|[quarkdown](https://quarkdown.com/)|[2.5.1](https://quarkdown.com/)|A modern Markdown-based typesetting system, designed around the key concept of versatility.|
...
|[quincy](https://github.com/quincy-rs/quincy)|[3.0.2](https://github.com/quincy-rs/quincy)|A VPN client and server implementation using the QUIC protocol with support for pre-quantum, hybrid and post-quantum cryptography.|
...
|[radius](https://radapp.io)|[0.60.0](https://radapp.io)|A cloud-native, portable application platform that makes app development easier for teams building cloud-native apps.|
|[rainfrog](https://github.com/achristmascarl/rainfrog)|[0.4.4](https://github.com/achristmascarl/rainfrog)|A database management TUI.|
...
|[rapidraw](https://github.com/CyberTimon/RapidRAW)|[1.6.1](https://github.com/CyberTimon/RapidRAW)|A beautiful, non-destructive, and GPU-accelerated RAW image editor built with performance in mind.|
...
|[rattler-build](https://github.com/prefix-dev/rattler-build)|[0.74.0](https://github.com/prefix-dev/rattler-build)|A universal Conda package builder (like conda-build but faster).|
...
|[rbspy](https://github.com/rbspy/rbspy)|[0.51.0](https://github.com/rbspy/rbspy)|Sampling CPU profiler for Ruby.|
...
|[rdiff-backup-pre](https://github.com/rdiff-backup/rdiff-backup)|[2.6.1.dev81+g4796290df](https://github.com/rdiff-backup/rdiff-backup/releases/expanded_assets/weekly)|(Pre-release Version) Reverse differential backup tool, over a network or locally.|
|[readaware](https://github.com/ahpxex/read-aware)|[0.4.2](https://github.com/ahpxex/read-aware)|An agent-first reader with a plugin system at its core.|
...
|[readest](https://github.com/chrox/readest)|[0.12.1](https://github.com/chrox/readest)|An open-source ebook reader designed for immersive and deep reading experiences.|
...
|[rebased](https://github.com/DetachHead/rebased)|[1.1.13](https://github.com/DetachHead/rebased)|An open-source remake of the short-lived JetBrains Git client.|
...
|[redis_exporter](https://github.com/oliver006/redis_exporter)|[1.89.0](https://github.com/oliver006/redis_exporter)|A Prometheus exporter for Redis metrics.|
...
|[redisee](https://redisee.com/)|[1.1.10](https://pkg.redisee.com/assets/releases.win-x64-stable.json)|A modern and beautiful GUI for Redis.|
...
|[redpanda-connect](https://docs.redpanda.com/redpanda-connect/about/)|[4.105.0](https://docs.redpanda.com/redpanda-connect/about/)|Redpanda Connect (Originally Benthos) is a high performance and resilient stream processor, able to connect various sources and sinks|
|[redpanda-minion](https://github.com/redpanda-data/kminion)|[2.3.5](https://github.com/redpanda-data/kminion)|Redpanda Minion (KMinion) is a feature-rich and flexible Prometheus Exporter to monitor your Redpanda or Kafka cluster.|
...
|[redumper](https://github.com/superg/redumper)|[744](https://github.com/superg/redumper/releases.atom)|A low level CD dumper utility.|
...
|[render-cli](https://render.com/docs/cli)|[2.24.0](https://render.com/docs/cli)|The official command-line interface for Render cloud hosting platform|
...
|[repkg](https://github.com/notscuffed/repkg)|[0.4.0-alpha](https://github.com/notscuffed/repkg/releases.atom)|A Wallpaper Engine PKG extractor and TEX to image converter.|
...
|[rerun-cli](https://rerun.io/)|[0.36.1](https://rerun.io/)|CLI for Rerun, the time-aware multimodal data stack and visualizations.|
...
|[resend-cli](https://resend.com/)|[2.13.0](https://resend.com/)|The official CLI for Resend.|
...
|[resterm](https://github.com/unkn0wn-root/resterm)|[1.2.1](https://github.com/unkn0wn-root/resterm)|A terminal-based REST/GraphQL/gRPC/WebSocket/SSE client.|
...
|[riba2534-feishu-cli](https://github.com/riba2534/feishu-cli)|[1.38.4](https://github.com/riba2534/feishu-cli)|飞书开放平台命令行工具 — Markdown 与飞书文档双向转换，AI Agent 的飞书操控引擎|
...
|[rigaya-nvenc](https://github.com/rigaya/NVEnc)|[9.32](https://github.com/rigaya/NVEnc/releases.atom)|Investigate performance and image quality of HW encoder (NVENC) of NVIDIA.|
|[rigaya-qsvenc](https://github.com/rigaya/QSVEnc)|[8.27](https://github.com/rigaya/QSVEnc)|Investigate performance and image quality of HW encoder (QSV) of Intel.|
|[rigaya-vceenc](https://github.com/rigaya/VCEEnc)|[9.12](https://github.com/rigaya/VCEEnc)|An AMD VCE hardware codec based command line video encoder.|
|[rimage_gui](https://github.com/Mikachu2333/rimage_gui)|[3.0.0](https://github.com/Mikachu2333/rimage_gui)|A GUI software use rimage to compress images batchly without affecting the look and feel.|
...
|[risoheditor](https://katahiromz.web.fc2.com/re/en/)|[6.1.4](https://katahiromz.web.fc2.com/re/en/)|RisohEditor is a free Win32 resource editor.|
...
|[rmcp-openapi-server](https://gitlab.com/lx-industries/rmcp-openapi)|[0.31.3](https://crates.io/api/v1/crates/rmcp-openapi-server?include=default_version)|An MCP server that exposes OpenAPI definition endpoints as MCP tools.|
...
|[roc-nightly](https://roc-lang.org/)|[2026-08-19-edec830](https://roc-lang.org/install_roc.ps1)|(Nightly Build) A fast, friendly, functional language.|
...
|[royalts](https://www.royalapps.com/ts/win)|[7.04.50819.0](https://www.royalapps.com/ts/win/download)|Comprehensive Remote Management Solution|
...
|[rpk](https://docs.redpanda.com/current/get-started/rpk/)|[26.2.1](https://docs.redpanda.com/current/get-started/rpk/)|Redpanda Keeper (rpk) is a single binary application that provides a way to interact with your Redpanda clusters from the command line.|
...
|[rsop](https://codeberg.org/heiko/rsop)|[0.11.0](https://crates.io/api/v1/crates/rsop?include=default_version)|A stateless OpenPGP (SOP) CLI tool based on rPGP and rpgpie.|
...
|[rssguard-nightly](https://github.com/martinrotter/rssguard/releases/tag/devbuild5)|[dev-20260819-0b2a71f3d](https://github.com/martinrotter/rssguard/releases/expanded_assets/devbuild5)|(Development Builds) A simple, light and easy-to-use RSS/ATOM feed aggregator developed using Qt framework which supports online feed synchronization.|
|[rssh](https://github.com/shihuili1218/rssh)|[0.2.17](https://github.com/shihuili1218/rssh)|A SSH connection manager with a desktop GUI and built-in CLI.|
...
|[runpodctl](https://www.runpod.io/)|[2.10.0](https://www.runpod.io/)|The CLI tool to automate / manage GPU pods for runpod.io.|
...
|[rustfs](https://github.com/rustfs/rustfs)|[1.0.0-rc.2](https://github.com/rustfs/rustfs/releases.atom)|A high-performance, distributed object storage system built in Rust.|
|[rustfs-cli](https://github.com/rustfs/cli)|[0.1.31](https://github.com/rustfs/cli/releases.atom)|A S3-compatible command-line client written in Rust.|
...
|[rusthound-ce](https://github.com/g0h4n/RustHound-CE)|[2.5.2](https://github.com/g0h4n/RustHound-CE)|Active Directory data ingestor for BloodHound Community Edition written in Rust.|
|[rustnet](https://github.com/domcyrus/rustnet)|[1.5.0](https://github.com/domcyrus/rustnet)|A cross-platform network monitoring terminal UI tool built with Rust.|
...
|[rustypaste-cli](https://github.com/orhun/rustypaste-cli)|[0.10.0](https://github.com/orhun/rustypaste-cli)|A CLI tool for rustypaste, a minimal file upload/pastebin service.|
|[rustywind](https://github.com/avencera/rustywind)|[0.27.0](https://github.com/avencera/rustywind)|CLI for organizing Tailwind CSS classes.|
|[rv](https://a2-ai.github.io/rv-docs/)|[0.22.2](https://a2-ai.github.io/rv-docs/)|A declarative R package manager, allowing you to quickly create reproducible projects.|
...
|[ryzentuner](https://github.com/zqhong/RyzenTuner)|[2026.07.13](https://github.com/zqhong/RyzenTuner)|A tool that supports adjusting the power limit of Ryzen mobile processors and the QoS level and priority of Windows processes.|
|[s-search](https://github.com/zquestz/s)|[0.8.1](https://github.com/zquestz/s)|Open a web search in your terminal.|
|[s2](https://github.com/klauspost/compress/tree/master/s2#s2-compression)|[1.19.2](https://github.com/klauspost/compress/tree/master/s2#s2-compression)|The commandline tool for S2, an extension of Snappy.|
...
|[s3proxy](https://github.com/gaul/s3proxy)|[4.0.0](https://github.com/gaul/s3proxy/releases.atom)|Access other storage backends via the S3 API.|
...
|[sakura-apprun-cli](https://github.com/fujiwara/apprun-cli)|[0.8.1](https://github.com/fujiwara/apprun-cli)|A command line interface for AppRun β Sakura Cloud.|
...
|[saucelabs-forwarder](https://opensource.saucelabs.com/forwarder/)|[1.6.1](https://opensource.saucelabs.com/forwarder/)|A production-ready, fast MITM proxy with PAC support.|
...
|[scalingo-cli](https://doc.scalingo.com/platform/cli/start)|[1.48.0](https://doc.scalingo.com/platform/cli/start)|The command Line client for Scalingo, a PaaS cloud hosting for developers.|
...
|[schildi-revenge](https://schildi.chat/revenge/)|[26.08.08](https://schildi.chat/revenge/)|A desktop Matrix client written in kotlin.|
...
|[score-compose](https://github.com/score-spec/score-compose)|[0.45.0](https://github.com/score-spec/score-compose)|A reference implementation of the Score specification for Docker compose, primarily used for local development.|
|[score-k8s](https://github.com/score-spec/score-k8s)|[0.16.0](https://github.com/score-spec/score-k8s)|A reference implementation of the Score specification for Kubernetes, converts Score files into a YAML file containing Kubernetes manifests|
...
|[screencapture](https://github.com/xland/ScreenCapture)|[2.5.13](https://github.com/xland/ScreenCapture)|A feature-rich screenshot program.|
...
|[sea-orm-cli](https://www.sea-ql.org/SeaORM/)|[2.0.2](https://crates.io/api/v1/crates/sea-orm-cli?include=default_version)|The command line utility for SeaORM.|
...
|[seaweedfs](https://github.com/seaweedfs/seaweedfs)|[4.42](https://github.com/seaweedfs/seaweedfs)|A fast distributed storage system for blobs, objects, files, and data lake, for billions of files.|
|[secretspec](https://secretspec.dev/)|[0.19.1](https://secretspec.dev/)|Declarative secrets, every environment, any provider.|
...
|[sem](https://github.com/Ataraxy-Labs/sem)|[0.22.1](https://github.com/Ataraxy-Labs/sem)|A semantic version control tool that works on top of Git.|
...
|[serverbox](https://github.com/lollipopkit/flutter_server_box)|[1.0.1480](https://github.com/lollipopkit/flutter_server_box)|A Flutter project which provide charts to display Linux server status and tools to manage server.|
|[servo-fetch](https://github.com/konippi/servo-fetch)|[0.14.0](https://github.com/konippi/servo-fetch)|A self-contained browser engine that fetches, renders, and extracts web content as Markdown, JSON, or screenshots — no Chromium, no API key, no setup.|
...
|[sftpgo](https://github.com/drakkan/sftpgo)|[2.7.5](https://github.com/drakkan/sftpgo)|Fully featured and highly configurable SFTP server with optional FTP/S and WebDAV support - S3, Google Cloud Storage, Azure Blob.|
...
|[shadowquic](https://github.com/spongebob888/shadowquic)|[0.3.12](https://github.com/spongebob888/shadowquic)|A 0-RTT QUIC Proxy with SNI camouflage.|
...
|[shimmy](https://github.com/Michael-A-Kuykendall/shimmy)|[2.5.0](https://crates.io/api/v1/crates/shimmy?include=default_version)|Lightweight 5MB Ollama alternative with native SafeTensors support.|
...
|[silo](https://silo.pigsty.io/)|[2026-08-06T00-00-00Z](https://github.com/pgsty/silo/releases.atom)|A conservatively maintained MinIO fork.|
|[silo-mcli](https://silo.pigsty.io/)|[2026-08-06T00-00-00Z](https://github.com/pgsty/mc/releases.atom)|CLI client for Silo, a conservatively maintained MinIO fork.|
...
|[simplejavamail-cli](https://www.simplejavamail.org/)|[9.3.2](https://repo1.maven.org/maven2/org/simplejavamail/cli-module/maven-metadata.xml)|The CLI for Simple Java Mail, a mailing library with a super clean API.|
|[simplex-desktop](https://simplex.chat/)|[7.0.1](https://simplex.chat/)|The official desktop application for SimpleX Chat, a messaging network operating without user identifiers of any kind.|
|[simpmusic](https://github.com/maxrave-dev/SimpMusic)|[1.7.0](https://github.com/maxrave-dev/SimpMusic)|A cross-platform music app using YouTube Music for backend.|
...
|[sing-box](https://sing-box.sagernet.org)|[1.13.19](https://sing-box.sagernet.org)|The universal proxy platform.|
|[sing-box-beta](https://sing-box.sagernet.org)|[1.14.0-beta.17](https://github.com/SagerNet/sing-box/releases.atom)|(Pre-release) The universal proxy platform.|
|[sing-geoip](https://sing-box.sagernet.org/configuration/route/geoip/)|[20260812](https://sing-box.sagernet.org/configuration/route/geoip/)|GeoIP database for sing-box.|
|[sing-geoip-rule-set](https://sing-box.sagernet.org/configuration/rule-set/)|[20260812-b9c5e67](https://api.github.com/repos/SagerNet/sing-geoip/branches/rule-set)|GeoIP rule set for sing-box.|
|[sing-geosite](https://sing-box.sagernet.org/configuration/route/geosite/)|[20260818030538](https://sing-box.sagernet.org/configuration/route/geosite/)|Geosite database for sing-box.|
|[sing-geosite-rule-set](https://sing-box.sagernet.org/configuration/rule-set/)|[20260819-b3e5c6a](https://api.github.com/repos/SagerNet/sing-geosite/branches/rule-set)|Geosite rule set for sing-box.|
...
|[slackdump](https://github.com/rusq/slackdump)|[4.4.4](https://github.com/rusq/slackdump)|Save or export your private and public Slack messages, threads, files, and users locally without admin privileges.|
...
|[sling](https://docs.slingdata.io/)|[1.5.26](https://docs.slingdata.io/)|A CLI tool that extracts data from a source storage/database and loads it in a target storage/database.|
...
|[smithy-cli](https://smithy.io)|[1.73.0](https://smithy.io)|A CLI for the Smithy interface definition language and code generation tools.|
...
|[snarkos](https://github.com/ProvableHQ/snarkOS)|[4.9.1](https://github.com/ProvableHQ/snarkOS/releases.atom)|A decentralized operating system for zero-knowledge applications.|
...
|[snishaper](https://github.com/coolapijust/SniShaper)|[1.29.0-alpha.5](https://github.com/coolapijust/SniShaper/releases.atom)|专为复杂网络环境设计的本地代理工具，旨在为用户提供稳定的访问体验|
...
|[sonarqube-cli](https://cli.sonarqube.com/)|[1.6.0.4255](https://binaries.sonarsource.com/Distribution/sonarqube-cli/stable.version)|A CLI for SonarQube with AI agent integration for code quality and security scanning.|
|[songloft-player](https://songloft.hanxi.cc/)|[2.11.5](https://songloft.hanxi.cc/)|Songloft 跨平台音乐播放器，连接面向个人用户的自托管音乐服务器|
...
|[source2viewer-nightly](https://s2v.app)|[b6996-20260819-1132a69](https://github.com/ValveResourceFormat/ValveResourceFormat/actions/workflows/build.yml?query=branch%3Amaster+event%3Apush+is%3Asuccess)|(Dev Builds) An all-in-one tool to browse VPK archives, view, extract, and decompile Source 2 assets.|
...
|[spacectl](https://spacelift.io/)|[1.25.0](https://spacelift.io/)|A utility wrapping Spacelift's GraphQL API for easy programmatic access in command-line contexts.|
...
|[speakeasy](https://speakeasy.com/)|[1.795.0](https://speakeasy.com/)|Generate client SDKs in popular languages from your OpenAPI spec with Speakeasy.|
...
|[spinnaker-cli](https://spinnaker.io/docs/guides/spin/)|[main-26](https://storage.googleapis.com/spinnaker-artifacts/spin/latest)|Spinnaker CLI for editing pipelines, applications, and configs.|
...
|[splayer-next](https://github.com/SPlayer-Dev/SPlayer-Next)|[1.0.0](https://github.com/SPlayer-Dev/SPlayer-Next/releases.atom)|跨平台桌面音乐播放器，支持丰富歌词与多种音频格式 | A desktop music player with rich lyric support and wide audio format compatibility.|
|[splayer-next-nightly](https://github.com/SPlayer-Dev/SPlayer-Next)|[b190-20260817-72cfea2](https://github.com/SPlayer-Dev/SPlayer-Next/actions/workflows/dev.yml?query=branch%3Adev+event%3Apush+is%3Asuccess)|（开发版）跨平台桌面音乐播放器，支持丰富歌词与多种音频格式 | (Nightly Build) A desktop music player with rich lyric support and wide audio format compatibility.|
...
|[splunk-acs-cli](https://docs.splunk.com/Documentation/SplunkCloud/latest/Config/ACSCLI)|[2.25.0](https://docs.splunk.com/Documentation/SplunkCloud/latest/Config/ACSCLI)|A command line interface that lets you perform many Splunk Cloud Platform configuration and management tasks in a self-service manner.|
...
|[spotatui](https://github.com/LargeModGames/spotatui)|[0.41.0](https://github.com/LargeModGames/spotatui)|A fully standalone Spotify client for the terminal.|
...
|[spotiflac](https://github.com/spotbye/SpotiFLAC)|[7.2.2](https://github.com/spotbye/SpotiFLAC)|Get Spotify tracks in true FLAC from Tidal, Qobuz & Amazon Music — no account required.|
...
|[sprite](https://fly.io/sprites)|[0.0.1-rc48](https://sprites-binaries.t3.storage.dev/client/rc.txt)|CLI for sprites, stateful sandbox environments with checkpoint & restore|
...
|[squix](https://github.com/eduardofuncao/squix)|[0.5.3-beta](https://github.com/eduardofuncao/squix/releases.atom)|A CLI tool for managing and executing SQL queries across multiple databases.|
|[sqz](https://github.com/ojuschugh1/sqz)|[1.6.1](https://github.com/ojuschugh1/sqz)|Compress LLM context to save tokens and reduce costs.|
...
|[ssh-vault](https://github.com/ssh-vault/ssh-vault)|[1.3.4](https://github.com/ssh-vault/ssh-vault)|Encrypt/decrypt using ssh keys.|
...
|[stable-diffusion-cpp](https://github.com/leejet/stable-diffusion.cpp)|[b827-97d2990](https://github.com/leejet/stable-diffusion.cpp/releases.atom)|(CPU Backend) stable-diffusion.cpp enables inference of Stable Diffusion and Flux in pure C/C++.|
|[stable-diffusion-cpp-cuda](https://github.com/leejet/stable-diffusion.cpp)|[b827-97d2990](https://github.com/leejet/stable-diffusion.cpp/releases.atom)|(CUDA 12 Backend) stable-diffusion.cpp enables inference of Stable Diffusion and Flux in pure C/C++.|
|[stable-diffusion-cpp-rocm](https://github.com/leejet/stable-diffusion.cpp)|[b827-97d2990](https://github.com/leejet/stable-diffusion.cpp/releases.atom)|(AMD ROCm/HIP Backend) stable-diffusion.cpp enables inference of Stable Diffusion and Flux in pure C/C++.|
|[stable-diffusion-cpp-vulkan](https://github.com/leejet/stable-diffusion.cpp)|[b827-97d2990](https://github.com/leejet/stable-diffusion.cpp/releases.atom)|(Vulkan Backend) stable-diffusion.cpp enables inference of Stable Diffusion and Flux in pure C/C++.|
...
|[stackit-cli](https://github.com/stackitcloud/stackit-cli)|[0.71.0](https://github.com/stackitcloud/stackit-cli)|A command-line interface for STACKIT - The German business cloud.|
|[stak](https://github.com/raviqqe/stak)|[0.12.23](https://github.com/raviqqe/stak)|The miniature, embeddable R7RS Scheme implementation in Rust.|
...
|[stax](https://cesarferreira.com/stax/)|[0.104.8](https://cesarferreira.com/stax/)|Stacked Git branches and PRs, fast, safe, and built for humans and AI agents.|
...
|[steam-lancache-prefill](https://github.com/tpill90/steam-lancache-prefill)|[3.7.1](https://github.com/tpill90/steam-lancache-prefill)|SteamPrefill automatically fills a Lancache with games from Steam, so that subsequent downloads for the same content will be served from the Lancache.|
...
|[steganographiergui](https://github.com/cenglin123/SteganographierGUI)|[1.3.10](https://github.com/cenglin123/SteganographierGUI/releases.atom)|隐写者是一款将文件或文件夹隐写到视频文件的工具|
...
|[stellar-cli](https://github.com/stellar/stellar-cli)|[27.1.0](https://github.com/stellar/stellar-cli)|A command-line tool for interacting with the Stellar network.|
...
|[stripe-cli](https://stripe.com/docs/stripe-cli)|[1.50.3](https://stripe.com/docs/stripe-cli)|A command-line tool for Stripe.|
...
|[sui](https://sui.io/)|[1.78.0](https://github.com/MystenLabs/sui/releases)|A next-generation smart contract platform with high throughput, low latency, and an asset-oriented programming model powered by the Move programming language.|
...
|[sumatrapdf-plus](https://github.com/dengxibo/sumatrapdf-plus)|[3.7.28](https://github.com/dengxibo/sumatrapdf-plus)|Unofficial fork of SumatraPDF, a document reader (PDF, EPUB, MOBI, and more) with improvements for Chinese ebooks, offline lookup, themes, and smart PDF dark mode.|
...
|[super](https://superdb.org)|[0.3.0](https://superdb.org)|SuperDB is an analytics database that puts JSON and relational tables on equal footing.|
...
|[superseedr](https://github.com/Jagalite/superseedr)|[1.0.13](https://github.com/Jagalite/superseedr)|A BitTorrent Client in your Terminal.|
|[superseedr-private](https://github.com/Jagalite/superseedr)|[1.0.13](https://github.com/Jagalite/superseedr)|(Private Tracker Builds) A BitTorrent Client in your Terminal.|
...
|[surfpool](https://surfpool.run)|[1.5.0](https://surfpool.run)|A local Solana development environment and drop-in replacement for solana-test-validator.|
...
|[svt-av1-hdr](https://github.com/juliobbv-p/svt-av1-hdr)|[2026-07-15-8b4b9f5](https://github.com/juliobbv-p/svt-av1-hdr/releases.atom)|An all-purpose AV1 video encoder designed for visually-optimal SDR and HDR image and video encoding.|
...
|[swell-proxy](https://github.com/yaog6700-bit/Swell-Proxy)|[3.3.2](https://github.com/yaog6700-bit/Swell-Proxy)|一款使用 WinUI 3 构建的 Windows 原生代理管理客户端|
...
|[switchfin](https://github.com/dragonflylee/switchfin)|[0.9.3](https://github.com/dragonflylee/switchfin)|A third-party PC player for Jellyfin that provides a native user interface to browse and play movies and series.|
|[syft](https://github.com/anchore/syft)|[1.51.0](https://github.com/anchore/syft)|A CLI tool and library for generating a Software Bill of Materials from container images and filesystems.|
...
|[syncclipboard](https://github.com/Jeric-X/SyncClipboard)|[3.2.0](https://github.com/Jeric-X/SyncClipboard)|跨平台剪贴板同步方案 / Cross-Platform Cipboard Syncing Solution|
...
|[syntaqlite](https://github.com/LalitMaganti/syntaqlite)|[0.9.0](https://github.com/LalitMaganti/syntaqlite)|A fast parser, formatter, static analyzer, and language server for SQLite SQL.|
...
|[tabiew](https://github.com/shshemi/tabiew)|[0.14.2](https://github.com/shshemi/tabiew)|A lightweight TUI application to view and query tabular data files, such as CSV, TSV, and parquet.|
...
|[tabularis](https://tabularis.dev)|[0.20.0](https://tabularis.dev)|A desktop SQL workspace for PostgreSQL, MySQL, SQLite, and more.|
...
|[talhelper](https://budimanjojo.github.io/talhelper)|[3.1.16](https://budimanjojo.github.io/talhelper)|A tool to help creating Talos kubernetes cluster.|
...
|[talm](https://github.com/cozystack/talm)|[0.34.0](https://github.com/cozystack/talm)|A tool to manage Talos Linux the GitOps way.|
...
|[tanka](https://tanka.dev/)|[0.38.0](https://tanka.dev/)|Flexible, reusable and concise configuration for Kubernetes.|
...
|[taubyte-cli](https://github.com/taubyte/tau-cli)|[0.1.16](https://github.com/taubyte/tau-cli)|A command-line tool for managing Taubyte projects, resources, and cloud workflows.|
|[taubyte-dream](https://taubyte.com)|[1.1.3](https://taubyte.com)|A local cloud for rapid development and testing.|
...
|[tdengine-client](https://www.taosdata.com/)|[3.4.2.5](https://www.taosdata.com/wp-content/themes/tdengine/js/product-data.json)|(OSS Version) An open-source big data platform designed and optimized for the Internet of Things (IoT).|
|[tdengine-enterprise-client](https://www.taosdata.com/)|[3.4.2.5](https://www.taosdata.com/wp-content/themes/tdengine/js/product-data.json)|(Enterprise Version) A big data platform designed and optimized for the Internet of Things (IoT).|
...
|[tencent-qqmail-agently-cli](https://agent.qq.com/)|[1.0.17](https://registry.npmjs.org/@tencent-qqmail/agently-cli/latest)|QQ 邮箱 Agent Mail 命令行工具，支持发送、回复、转发、搜索、读取邮件、下载附件、管理收件箱|
...
|[termsonic](https://git.sixfoisneuf.fr/termsonic/about/)|[0.3-20260405](https://git.sixfoisneuf.fr/releases/termsonic/)|A TUI client for any Subsonic-compatible server.|
|[terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server)|[1.2.0](https://github.com/hashicorp/terraform-mcp-server)|The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.|
...
|[testkube](https://testkube.io/)|[2.12.1](https://testkube.io/)|Kubernetes-native testing framework for test execution and orchestration.|
...
|[teyvatguide](https://github.com/BTMuli/TeyvatGuide)|[0.11.4](https://github.com/BTMuli/TeyvatGuide)|A game tool for Genshin Impact players.|
...
|[tgpt](https://github.com/aandrew-me/tgpt)|[2.13.0](https://github.com/aandrew-me/tgpt)|A CLI tool that allows you to use AI chatbot in your Terminal without requiring API keys.|
...
|[throne](https://github.com/throneproj/Throne)|[1.2.4](https://github.com/throneproj/Throne/releases.atom)|A cross-platform GUI proxy utility (Empowered by sing-box)|
...
|[tigris-cli](https://www.tigrisdata.com)|[3.9.0](https://github.com/tigrisdata/storage/releases.atom)|Command line interface for Tigris object storage.|
...
|[timoni](https://timoni.sh/)|[0.32.0](https://timoni.sh/)|A package manager for Kubernetes, powered by CUE and inspired by Helm.|
...
|[tkn-pac](https://pipelinesascode.com/)|[0.50.0](https://pipelinesascode.com/)|A command line interface for interacting with Pipelines-as-Code for Tekton.|
...
|[tldfinder](https://github.com/projectdiscovery/tldfinder)|[0.0.2](https://github.com/projectdiscovery/tldfinder)|A streamlined tool for discovering private TLDs for security research.|
|[tldx](https://github.com/brandonyoungdev/tldx)|[1.6.0](https://github.com/brandonyoungdev/tldx)|tldx helps you brainstorm available domain names fast.|
...
|[tokensave](https://github.com/aovestdipaperino/tokensave)|[7.10.0](https://github.com/aovestdipaperino/tokensave/releases.atom)|A comprehensive code intelligence MCP server for AI coding agents.|
|[tokscale](https://github.com/junhoyeo/tokscale)|[4.13.0](https://registry.npmjs.org/@tokscale/cli/latest)|Track token usage across AI coding agents from your terminal.|
|[tombi](https://tombi-toml.github.io/tombi/)|[1.4.0](https://tombi-toml.github.io/tombi/)|A powerful toolkit that provides a TOML Formatter, Linter, and Language Server to help you maintain clean and consistent TOML files.|
...
|[toolhive](https://github.com/stacklok/toolhive)|[0.44.0](https://github.com/stacklok/toolhive)|ToolHive simplifies the deployment and management of Model Context Protocol (MCP) servers.|
...
|[tpnote](https://gitlab.com/getreu/tp-note)|[1.27.0](https://gitlab.com/getreu/tp-note)|Tp-Note is a minimalistic note taking tool that saves and edits clipboard content as a note file.|
...
|[trajan](https://github.com/praetorian-inc/trajan)|[1.0.2](https://github.com/praetorian-inc/trajan)|A multi-platform CI/CD vulnerability detection and attack automation tool for identifying security weaknesses in pipeline configurations.|
...
|[trdl](https://trdl.dev/)|[0.13.0](https://trdl.dev/)|A universal package manager delivering new versions of your application from a trusted TUF repository.|
...
|[treemd](https://github.com/Epistates/treemd)|[0.6.0](https://github.com/Epistates/treemd)|A (TUI/CLI) markdown navigator with tree-based structural navigation.|
...
|[truehdd](https://github.com/truehdd/truehdd)|[0.6.1](https://github.com/truehdd/truehdd)|A tool for inspecting and decoding Dolby TrueHD bitstreams.|
...
|[tssh](https://github.com/trzsz/trzsz-ssh)|[0.1.26](https://github.com/trzsz/trzsz-ssh)|An alternative to ssh client, offers additional useful features, such as login prompt, trzsz ( trz / tsz ), batch login, remember password, zmodem ( rz / sz ), etc.|
|[tsuru](https://tsuru.io)|[1.35.0](https://tsuru.io)|tsuru-client is a tsuru command line tool for application developers.|
...
|[tty7](https://github.com/l0ng-ai/tty7)|[26.8.3](https://github.com/l0ng-ai/tty7)|A GPU-rendered, daemon-backed terminal in pure Rust.|
|[tuba](https://tuba.geopjr.dev/)|[b1876](https://github.com/GeopJr/Tuba/actions/workflows/msys2.yml?query=event%3Apush+branch%3Amain+is%3Asuccess)|Browse the Fediverse.|
|[tubatools](https://tubawinui3.cn/)|[1.5.3](https://tubawinui3.cn/)|图吧工具箱是一款开源、现代、免费的PC 硬件检测与系统维护工具集|
...
|[tui-test](https://github.com/microsoft/tui-test)|[0.1.0-beta.1](https://github.com/microsoft/tui-test/releases.atom)|Make the terminal/shell accessible for AI agents to automate tasks with ease.|
...
|[turbo-browser](https://tbrowser.cn/)|[151.0.7922.116](https://github.com/tbrowser/Turbo-Browser/releases.atom)|一款纯粹的高效浏览器，启动快，跑分高，适合希望继续留在 Chromium 生态、又需要更强效率与迁移体验的用户|
...
|[ty](https://github.com/astral-sh/ty)|[0.0.73](https://github.com/astral-sh/ty/releases.atom)|An extremely fast Python type checker and language server, written in Rust.|
...
|[typedb](https://typedb.com)|[3.12.3](https://typedb.com)|A strongly-typed database with a rich type system and TypeQL query language.|
|[typedb-studio](https://typedb.com/docs/tools/studio/)|[3.12.2](https://typedb.com/docs/tools/studio/)|An interactive visual environment for TypeDB.|
...
|[typeql-check](https://typedb.com/docs/tools/typeql-check/)|[3.12.0](https://github.com/typedb/typedb-tools/releases.atom)|A small CLI tool to validate TypeQL query syntax without sending it to a TypeDB server.|
...
|[typstyle](https://github.com/Enter-tainer/typstyle)|[0.15.1](https://github.com/Enter-tainer/typstyle)|A beautiful and reliable code formatter for Typst.|
...
|[undertalemodtool](https://github.com/UnderminersTeam/UndertaleModTool)|[0.9.1.2](https://github.com/UnderminersTeam/UndertaleModTool)|A complete tool for modding, decompiling and unpacking Undertale and other GameMaker games.|
|[undertalemodtool-cli](https://github.com/UnderminersTeam/UndertaleModTool)|[0.9.1.2](https://github.com/UnderminersTeam/UndertaleModTool)|CLI version of UndertaleModTool, a tool for modding, decompiling and unpacking Undertale and other GameMaker games.|
|[undoc](https://github.com/iyulab/undoc)|[0.8.0](https://github.com/iyulab/undoc)|A high-performance tool for extracting content from DOCX, XLSX, and PPTX into Markdown, plain text, or JSON.|
...
|[unicodia](https://mercury13.github.io/unicodia/)|[3.2.4](https://mercury13.github.io/unicodia/)|An encyclopedia of Unicode characters.|
...
|[unpdf](https://github.com/iyulab/unpdf)|[0.12.0](https://github.com/iyulab/unpdf)|A high-performance PDF content extraction tool that converts to Markdown, text, and JSON.|
...
|[uplink](https://docs.storj.io/api-reference/uplink-cli)|[1.162.3](https://docs.storj.io/api-reference/uplink-cli)|A command-line application that supports interacting with the Storj DCS network.|
...
|[us3cli](https://docs.ucloud.cn/ufile/tools/us3cli/introduction)|[1.7.18](http://us3-release.cn-bj.ufileos.com/us3cli/us3cli_latest_version.txt)|一款通过命令行操作对 UCloud 对象存储（US3）进行数据管理的工具|
...
|[usage](https://usage.jdx.dev/)|[5.1.0](https://usage.jdx.dev/)|A specification for CLIs.|
...
|[usbtree](https://gnomeria.github.io/usbtree/)|[0.1.1](https://gnomeria.github.io/usbtree/)|A TUI tool for inspecting the USB device tree.|
|[usbtreeview](https://www.uwe-sieber.de/usbtreeview_e.html)|[4.7.3](https://www.uwe-sieber.de/usbtreeview_e.html)|USB Device Tree Viewer is an USB information tool for Windows.|
...
|[vaults3](https://www.vaults3.com)|[4.4.53](https://www.vaults3.com)|A lightweight, S3-compatible object storage server with built-in web dashboard.|
...
|[vercel](https://vercel.com/)|[58.4.0](https://registry.npmjs.org/@vercel/vc-native-win32-x64/latest)|Native CLI for Vercel, a unified platform for building modern applications.|
|[verible](https://github.com/chipsalliance/verible)|[0.0-4148-g1ea007ec](https://github.com/chipsalliance/verible/releases.atom)|A suite of SystemVerilog developer tools, including a parser, style-linter, formatter and language server.|
|[versatiles](https://versatiles.org/)|[4.8.0](https://versatiles.org/)|A toolbox for converting, checking and serving map tiles in various formats.|
...
|[vespa-cli](https://vespa.ai)|[8.738.17](https://vespa.ai)|The command-line interface for the Vespa AI search platform.|
...
|[viaproxy](https://github.com/ViaVersion/ViaProxy)|[3.4.12](https://github.com/ViaVersion/ViaProxy)|A standalone proxy which allows players to join EVERY Minecraft server version (Classic, Alpha, Beta, Release, Bedrock).|
...
|[victoria-metrics](https://docs.victoriametrics.com/)|[1.150.0](https://docs.victoriametrics.com/quick-start/)|A fast, cost-effective and scalable monitoring solution and time series database.|
|[victoria-metrics-cluster](https://docs.victoriametrics.com/Cluster-VictoriaMetrics.html)|[1.150.0](https://docs.victoriametrics.com/quick-start/)|(Cluster version) A fast, cost-effective and scalable monitoring solution and time series database.|
...
|[videoduplicatefinder](https://github.com/0x90d/videoduplicatefinder)|[3.0-452-35360a8](https://github.com/0x90d/videoduplicatefinder/actions/workflows/releases.yml?query=event%3Apush+is%3Asuccess+branch%3Amaster)|A cross-platform software to find duplicated video (and image) files on hard disk based on similarity.|
|[videoduplicatefinder-cli](https://github.com/0x90d/videoduplicatefinder)|[3.0-452-35360a8](https://github.com/0x90d/videoduplicatefinder/actions/workflows/releases.yml?query=event%3Apush+is%3Asuccess+branch%3Amaster)|(CLI Version) A cross-platform software to find duplicated video (and image) files on hard disk based on similarity.|
|[videofusion](https://271374667.github.io/VideoFusion/)|[1.12.5](https://271374667.github.io/VideoFusion/)|一站式批量化视频处理工具|
|[vii3](https://github.com/vvyoko/Vii3)|[3.3.25](https://github.com/vvyoko/Vii3)|A high-performance frameless image viewer based on Avalonia, delivering ultra-smooth switching experience, comprehensive format support.|
...
|[vmaware](https://github.com/NotRequiem/VMAware)|[2.8.1](https://github.com/NotRequiem/VMAware)|A cross-platform virtual machine detection CLI tool.|
|[vmutils](https://docs.victoriametrics.com/vmctl.html)|[1.150.0](https://docs.victoriametrics.com/quick-start/)|Utils for Victoria Metrics|
|[vmutils-enterprise](https://docs.victoriametrics.com/vmctl.html)|[1.150.0](https://docs.victoriametrics.com/quick-start/)|Utils for Victoria Metrics Enterprise|
...
|[volcengine-cli](https://www.volcengine.com/docs/83927/1176799)|[1.1.3](https://www.volcengine.com/docs/83927/1176799)|通过命令行调用火山引擎云服务的OpenAPI，便于自动、高效管理云上资源|
...
|[vscli](https://github.com/michidk/vscli/)|[1.3.3](https://github.com/michidk/vscli/)|A CLI/TUI which makes it easy to launch vscode projects, with a focus on dev containers.|
...
|[vtracer](https://github.com/visioncortex/vtracer)|[1.0.0-alpha.3](https://github.com/visioncortex/vtracer/releases.atom)|An open source software to convert raster images (like jpg & png) into vector graphics (svg).|
...
|[vultr-cli](https://github.com/vultr/vultr-cli)|[3.11.0](https://github.com/vultr/vultr-cli)|The official command line tool for Vultr services.|
|[vykar](https://vykar.borgbase.com/)|[0.19.1](https://vykar.borgbase.com/)|A fast, encrypted, deduplicated backups in Rust — with friendly YAML config, a desktop GUI, and support for S3, custom REST and SFTP storage.|
...
|[wash](https://wasmcloud.com/)|[2.7.0](https://github.com/wasmCloud/wasmCloud/releases.atom)|Wasm Shell (wash) is the comprehensive command-line tool for developing, building, and managing WebAssembly components.|
|[wasm-bindgen-cli](https://wasm-bindgen.github.io/wasm-bindgen/)|[0.2.127](https://wasm-bindgen.github.io/wasm-bindgen/)|A CLI tool that facilitate high-level interactions between Wasm modules and JavaScript.|
...
|[wasm-tools](https://github.com/bytecodealliance/wasm-tools)|[1.257.1](https://github.com/bytecodealliance/wasm-tools)|A CLI for low-level manipulation of WebAssembly modules.|
|[wassette](https://github.com/microsoft/wassette)|[0.6.0](https://github.com/microsoft/wassette)|A security-oriented runtime that runs WebAssembly Components via MCP.|
...
|[weathr](https://github.com/veirt/weathr)|[1.4.0](https://github.com/veirt/weathr)|A terminal weather app with ASCII animation.|
|[weave](https://github.com/Ataraxy-Labs/weave)|[0.5.1](https://github.com/Ataraxy-Labs/weave)|Entity-level semantic merge driver for Git.|
|[webchangemonitor](https://sourceforge.net/projects/webchangemon/)|[26.08](https://sourceforge.net/projects/webchangemon/rss?path=/Windows)|Monitors a number of web pages and tracks changes based on the content of the web pages.|
...
|[wecom-cli](https://github.com/WecomTeam/wecom-cli)|[1.1.0](https://registry.npmjs.org/@wecom/cli/latest)|企业微信命令行工具 — 让人类和 AI Agent 都能在终端中操作企业微信|
|[werf](https://werf.io/)|[2.75.3](https://werf.io/)|A CLI tool gluing Git, Docker, Helm, and Kubernetes with any CI system to implement CI/CD and Giterminism.|
|[weron](https://github.com/pojntfx/weron)|[0.3.0](https://github.com/pojntfx/weron)|Overlay networks based on WebRTC.|
|[wgcf](https://github.com/ViRb3/wgcf)|[2.2.32](https://github.com/ViRb3/wgcf)|An unofficial, cross-platform CLI for Cloudflare Warp.|
...
|[whispersubtranslate](https://github.com/Blue-B/WhisperSubTranslate)|[2.4.6](https://github.com/Blue-B/WhisperSubTranslate)|A free, local desktop app to extract subtitles (SRT) from video and translate them into any language — unlimited use, no signup, no cloud.|
...
|[winappcli](https://github.com/microsoft/winappCli)|[0.6.0](https://github.com/microsoft/winappCli)|The Windows App Development CLI (winapp CLI) is a single command-line interface for managing Windows SDKs, packaging, generating app identity, manifests, certificates, and using build tools with any app framework.|
...
|[window-switcher](https://github.com/sigoden/window-switcher)|[1.19.0](https://github.com/sigoden/window-switcher)|Easily switch between windows of the same app with Alt+` (Backtick), also switch between apps with Alt+Tab.|
|[windows_exporter](https://github.com/prometheus-community/windows_exporter)|[0.31.8](https://github.com/prometheus-community/windows_exporter)|A Prometheus exporter for Windows machines.|
...
|[winexit](https://web.archive.org/web/20251013185259/https://www.pazera-software.com/products/winexit/)|[<i>1.0</i>](https://web.archive.org/web/20251013185259/https://www.pazera-software.com/products/winexit/)|A program that allows you to shut down, restart, sleep, hibernate your computer at the specified time.|
...
|[wing-101](https://wingware.com/downloads/wing-101)|[12.0.2.0](https://wingware.com/downloads/wing-101)|A very simple free Python IDE designed for teaching beginning programmers, that omits most features found in Wing Pro.|
...
|[winpaste](https://github.com/eq1024/WinPaste)|[1.7.0](https://github.com/eq1024/WinPaste/releases.atom)|快速、轻量且功能强大的 Windows 剪贴板增强工具，无缝替换系统自带的Win+V历史功能，无需学习即可上手|
...
|[wj-markdown-editor](https://github.com/nlbwqmz/wj-markdown-editor)|[2.19.7](https://github.com/nlbwqmz/wj-markdown-editor)|一款支持webdav的开源桌面端markdown编辑器|
...
|[woterm](https://www.woterm.com/)|[10.6.8](https://down.woterm.com/.softver)|A cross platform remote access management tool, out of the box, no configuration, safe and stable.|
...
|[wsl-dashboard](https://github.com/owu/wsl-dashboard)|[0.10.0](https://github.com/owu/wsl-dashboard)|A modern, high-performance, and lightweight WSL (Windows Subsystem for Linux) instance management dashboard.|
...
|[wubi-dict-editor](https://github.com/KyleBing/wubi-dict-editor)|[1.33](https://github.com/KyleBing/wubi-dict-editor)|五笔码表助手 for Rime，主要服务于 rime-wubi86-jidian 方案|
...
|[wxwork](https://work.weixin.qq.com/)|[5.0.10.6015](https://work.weixin.qq.com/)|企业微信是腾讯微信团队为企业打造的专业办公管理工具，与微信一致的沟通体验，丰富免费的OA应用，并与微信消息、小程序、微信支付等互通，助力企业高效办公和管理|
...
|[xash3d-fwgs-nightly](https://github.com/FWGS/xash3d-fwgs)|[0.20260818.1428](https://github.com/FWGS/xash3d-fwgs/releases/expanded_assets/continuous)|(Nightly Version) A game engine, aimed to provide compatibility with Half-Life Engine and extend it, as well as to give game developers well known workflow.|
|[xberg](https://docs.xberg.io)|[1.0.14](https://docs.xberg.io)|A document intelligence CLI for extracting text, metadata, images, and structured data from 100+ file formats.|
...
|[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)|[2.5.0](https://github.com/xpzouying/xiaohongshu-mcp/releases.atom)|MCP for 小红书 / xiaohongshu.com|
...
|[xk6](https://github.com/grafana/xk6)|[1.4.11](https://github.com/grafana/xk6)|Build k6 with extensions.|
...
|[xpipe](https://xpipe.io/)|[23.9](https://xpipe.io/)|A new type of shell connection hub and remote file manager that allows you to access your entire server infrastructure from your local machine.|
...
|[xtb-nightly](https://github.com/grimme-lab/xtb)|[0.20260809.1301](https://github.com/grimme-lab/xtb/releases/expanded_assets/bleed)|(Nightly Version) Semiempirical extended tight-binding program package.|
...
|[xyplorer](https://www.xyplorer.com/)|[27.20.1500](https://www.xyplorer.com/version.php)|A fast, powerful, pretty, and easy-to-use file manager for Windows|
|[yabasanshiro](https://www.yabasanshiro.com/)|[1.20.37](https://www.yabasanshiro.com/download)|Yaba Sanshiro is a Sega Saturn emulator.|
...
|[yandex-cloud-cli](https://cloud.yandex.ru/docs/cli/)|[1.27.0](https://storage.yandexcloud.net/yandexcloud-yc/release/stable)|Command line interface that helps you interact with Yandex Cloud services.|
...
|[yoke](https://github.com/yokecd/yoke)|[0.20.27](https://github.com/yokecd/yoke/releases.atom)|A Helm-inspired infrastructure-as-code (IaC) package deployer.|
...
|[yomo](https://yomo.run/)|[2.1.0](https://yomo.run/)|An open-source LLM Function Calling Framework for building scalable and ultra-fast AI Agents.|
...
|[youtubedr](https://github.com/kkdai/youtube)|[2.10.6](https://github.com/kkdai/youtube)|A tool to download YouTube videos.|
...
|[youtui](https://github.com/nick42d/youtui)|[0.0.38](https://crates.io/api/v1/crates/youtui?include=default_version)|A simple TUI for YouTube Music.|
...
|[ytsub](https://github.com/sarowish/ytsub)|[0.10.0](https://github.com/sarowish/ytsub)|A subscriptions only TUI YouTube client.|
|[ytt](https://carvel.dev/ytt/)|[0.55.2](https://carvel.dev/ytt/)|YAML templating tool that works on YAML structure instead of text.|
...
|[zaparoo](https://zaparoo.org/)|[2.16.1](https://zaparoo.org/)|An open source universal loading system that lets you launch games and media instantly using physical objects.|
...
|[zedis](https://github.com/vicanso/zedis)|[0.8.0](https://github.com/vicanso/zedis)|A high-performance, GPU-accelerated Redis client built with Rust and GPUI.|
...
|[zerolaunch](https://github.com/ghost-him/ZeroLaunch-rs)|[1.1.1](https://github.com/ghost-him/ZeroLaunch-rs)|极速精准、轻量纯粹的 Windows 应用程序启动器|
...
|[zig-zlint](https://github.com/DonIsaac/zlint)|[0.9.1](https://github.com/DonIsaac/zlint)|A linter for the Zig programming language.|
...
|[zip-password-finder](https://github.com/agourlay/zip-password-finder)|[0.12.0](https://github.com/agourlay/zip-password-finder)|A tool to find the password of protected zip files.|
...
|[zizmor](https://docs.zizmor.sh/)|[1.30.0-rc1](https://github.com/zizmorcore/zizmor/releases.atom)|A static analysis tool for GitHub Actions.|
...
|[zlibrary](https://1lib.sk)|[3.2.1](https://dln1.ncdn.ec/general-files/soft/desktop/latest.yml)|The Z-Library launcher for desktop.|
...
|[zotero-beta](https://www.zotero.org/)|[10.0.1-beta.1](https://www.zotero.org/)|Open-source reference management software to manage bibliographic data and related research materials.|
...
|[zsign](https://github.com/zhlynn/zsign)|[1.1.1](https://github.com/zhlynn/zsign)|Cross-platform codesign alternative for iOS 12+|
