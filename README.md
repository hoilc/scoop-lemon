...
|[aardio](https://www.aardio.com/)|[43.4.0](http://d.aardio.com/ide/check/)|aardio 编程语言，专注于桌面软件快速开发|
...
|[all-smi](https://github.com/lablup/all-smi)|[0.24.2](https://github.com/lablup/all-smi)|A command-line utility for monitoring GPU and NPU hardware.|
...
|[ansel](https://ansel.photos/)|[0.0.0+4069.gb171b04de0](https://github.com/aurelienpierreeng/ansel/releases/expanded_assets/v0.0.0)|A darktable fork minus the bloat plus some design vision.|
...
|[anymex](https://github.com/RyanYuuki/AnymeX)|[3.1.1](https://github.com/RyanYuuki/AnymeX/releases.atom)|A multiservice tracking client designed exclusively for managing and tracking anime and manga progress across AniList, MyAnimeList, and Simkl.|
...
|[aube](https://aube.jdx.dev/)|[1.33.1](https://aube.jdx.dev/)|A fast Node.js package manager.|
...
|[azd](https://aka.ms/azure-dev/devhub)|[1.28.1](https://azuresdkartifacts.z5.web.core.windows.net/azd/standalone/release/latest/version.txt)|A developer CLI that accelerates the time it takes for you to get started on Azure.|
...
|[bbdown](https://github.com/AliverAnme/BBDown)|[1.6.6](https://github.com/AliverAnme/BBDown)|(Active Fork) A command-line downloader for Bilibili.|
...
|[benthos](https://docs.redpanda.com/redpanda-connect/about/)|[4.102.0](https://docs.redpanda.com/redpanda-connect/about/)|Redpanda Connect (Originally Benthos) is a high performance and resilient stream processor, able to connect various sources and sinks|
...
|[bettergi-alpha](https://bettergi.com/)|[0.62.2-alpha.2](https://mirrorchyan.com/api/resources/BGI/latest?user_agent=BetterGI&os=win&arch=x64&channel=alpha)|（测试版）BetterGI · 更好的原神 - UI Automation Testing Tools For Genshin Impact|
|[betterleaks](https://betterleaks.com)|[1.7.0](https://betterleaks.com)|A configurable, fast, and thorough secrets scanner.|
...
|[bililive-go](https://github.com/bililive-go/bililive-go)|[0.8.0-rc.10](https://github.com/bililive-go/bililive-go/releases.atom)|一个支持多种直播平台的直播录制工具|
...
|[boxplayer](https://github.com/gaozhangmin/boxplayer)|[5.0.8](https://github.com/gaozhangmin/boxplayer/releases.atom)|小白羊网盘 BoxPlayer - 多网盘统一管理 + 智能媒体库 + 媒体服务器 + 高速下载|
...
|[buildkite](https://github.com/barnybug/cli53)|[3.54.1](https://github.com/barnybug/cli53)|The command line interface for Buildkite, a scale-out delivery platform.|
...
|[categraf](https://github.com/flashcatcloud/categraf)|[0.5.16](https://github.com/flashcatcloud/categraf)|One-stop telemetry collector for nightingale / prometheus / m3db / victoriametrics / thanos / influxdb / tdengine.|
...
|[catsxp](https://www.catsxp.com)|[6.7.5](https://www.catsxp.com)|猫眼浏览器是一款以简约安全为目标Chrome内核增强版浏览器|
...
|[ccusage](https://ccusage.com/)|[20.0.18](https://registry.npmjs.org/ccusage/latest)|Analyze coding (agent) CLI token usage and costs from local data.|
...
|[cdncheck](https://github.com/projectdiscovery/cdncheck)|[1.2.46](https://github.com/projectdiscovery/cdncheck)|A utility to detect various technology for a given IP address.|
...
|[cdxgen](https://cyclonedx.github.io/cdxgen/)|[12.8.2](https://cyclonedx.github.io/cdxgen/)|CycloneDX Generator is a CLI tool to create a valid and compliant CycloneDX Bill of Materials (BOM).|
...
|[clarinet](https://github.com/stx-labs/clarinet)|[3.22.0](https://github.com/stx-labs/clarinet)|A command line tool which is designed to write, test and deploy high-quality smart contracts to the Stacks blockchain and Bitcoin.|
|[clash-nyanpasu-nightly](https://nyanpasu.elaina.moe/)|[2.0.0-alpha+a2c9045](https://github.com/libnyanpasu/clash-nyanpasu/releases/expanded_assets/pre-release)|An opinionated Clash GUI based on Tauri.|
...
|[clippi](https://github.com/Ruszero01/clippi)|[0.3.9](https://github.com/Ruszero01/clippi)|轻量化剪贴板管理工具，使用 Rust + GPUI 构建 | Lightweight clipboard manager built with Rust and GPUI.|
...
|[cnspec](https://github.com/mondoohq/cnspec)|[13.30.1](https://github.com/mondoohq/cnspec/releases.atom)|An open source, cloud-native security to protect everything from build to runtime|
...
|[codanna](https://github.com/bartolli/codanna)|[0.11.1](https://github.com/bartolli/codanna)|Code intelligence system with semantic search.|
...
|[codexplusplus](https://github.com/BigPizzaV3/CodexPlusPlus)|[1.2.43](https://github.com/BigPizzaV3/CodexPlusPlus)|An enhanced tool for CodexApp, striving to make Codex better to use and more comfortable.|
...
|[component-detection](https://github.com/microsoft/component-detection)|[7.1.10](https://github.com/microsoft/component-detection)|Scans your project to determine what components you use.|
...
|[concord](https://github.com/chojs23/concord)|[2.4.6](https://github.com/chojs23/concord)|A feature-rich TUI client for Discord.|
...
|[cpp2il-nightly](https://github.com/SamboyCoding/Cpp2IL)|[b1655](https://github.com/SamboyCoding/Cpp2IL/actions/workflows/dotnet-core.yml?query=event%3Apush+is%3Asuccess+branch%3Adevelopment)|(Nightly Build) A work-in-progress tool to reverse unity's IL2CPP toolchain.|
...
|[crush](https://github.com/charmbracelet/crush)|[0.87.0](https://github.com/charmbracelet/crush)|A powerful terminal-based AI assistant for developers, providing intelligent coding assistance directly in your terminal.|
...
|[cvc5-nightly](https://cvc5.github.io/)|[2026-07-26-6bf8b59](https://github.com/cvc5/cvc5/releases/expanded_assets/latest)|(Nightly Build) An efficient open-source automatic theorem prover for Satisfiability Modulo Theories (SMT) problems.|
...
|[dbx](https://github.com/t8y2/dbx)|[0.5.66](https://github.com/t8y2/dbx)|A lightweight database client with support for MySQL, PostgreSQL, Redis, MongoDB, DuckDB, ClickHouse, SQL Server, and more.|
...
|[deja-vu](https://github.com/vshulcz/deja-vu)|[0.15.7](https://github.com/vshulcz/deja-vu)|Memory layer for coding agents: search, MCP recall, auto-context, secret redaction, stats, share and sync over the session logs Claude Code, Codex and opencode already write.|
...
|[detect-it-easy-beta](https://github.com/horsicq/Detect-It-Easy)|[4.0.0-20260726](https://github.com/horsicq/DIE-engine/releases/expanded_assets/Beta)|(BETA Version) Detect It Easy (DiE) is a powerful tool for file type identification.|
...
|[dlss-updater](https://github.com/Recol/DLSS-Updater)|[4.5.1](https://github.com/Recol/DLSS-Updater)|Update all the DLSS/XeSS DLLs for the games detected on your system.|
...
|[dnscontrol](https://stackexchange.github.io/dnscontrol/)|[4.44.1](https://stackexchange.github.io/dnscontrol/)|Synchronize your DNS to multiple providers from a simple DSL.|
...
|[drawio](https://www.diagrams.net/)|[31.0.2](https://www.diagrams.net/)|A diagramming app for making flowcharts, process diagrams, org charts, UML, ER and network diagrams.|
...
|[duckling](https://github.com/l1xnan/duckling)|[0.56.1](https://github.com/l1xnan/duckling)|A fast viewer for CSV/Parquet files and databases such as DuckDB, SQLite, PostgreSQL, MySQL, Clickhouse, etc.|
...
|[echosync](https://www.luminescence-software.org/en/echosync/about/)|[9.0.1.2](https://api.luminescence-software.org/get_latest_version.php?software=echosync)|A simple and fast software for differential file synchronization.|
...
|[entire](https://entire.io)|[0.8.42](https://entire.io)|A CLI that hooks into your Git workflow to capture and index AI agent sessions alongside commits.|
...
|[fabric-ai](https://github.com/danielmiessler/fabric)|[1.4.460](https://github.com/danielmiessler/fabric)|An open-source framework for augmenting humans using AI.|
...
|[ffmpegfreeui](https://github.com/Lake1059/FFmpegFreeUI)|[6.1.20](https://github.com/Lake1059/FFmpegFreeUI)|FFmpegFreeUI（简称 3FUI）是在 Windows 上的 FFmpeg 的专业交互外壳，收录大量参数，界面美观，交互友好|
...
|[files-cli](https://developers.files.com/cli/)|[2.15.416](https://developers.files.com/cli/)|The commandline app for Files.com.|
...
|[fleetctl](https://fleetdm.com/)|[4.89.2](https://github.com/fleetdm/fleet/releases.atom)|A CLI tool for managing Fleet, an open-source platform for IT, security, and infrastructure teams.|
|[flix](https://flix.center/)|[1.8.1](https://scoop-lemon.tari.xyz/hosted/flix/latest.yml)|Flix 快传，像聊天一样传文件|
|[floci](https://floci.io/)|[0.1.9](https://floci.io/)|Official command-line interface for Floci — the free, open-source local cloud emulator for AWS, GCP, and Azure.|
...
|[fluentcleaner](https://github.com/builtbybel/FluentCleaner)|[26.07.04](https://github.com/builtbybel/FluentCleaner/releases.atom)|A real WinUI desktop cleaner with terminal control and multi-database support.|
|[fluentcleaner-classic](https://github.com/builtbybel/FluentCleaner)|[1.08.066](https://github.com/builtbybel/FluentCleaner/releases.atom)|A lightweight portable desktop cleaner built on .NET Framework 4.8 with Winapp2.ini and Winapp3.ini support.|
...
|[flux-operator-mcp](https://fluxcd.control-plane.io/mcp/)|[0.56.0](https://fluxcd.control-plane.io/mcp/)|Flux MCP Server connects AI assistants directly to your Kubernetes clusters running Flux Operator, enabling seamless interaction through natural language.|
|[fluxdown](https://fluxdown.zerx.dev/)|[0.2.5-rc.2](https://github.com/zerx-lab/FluxDown/releases.atom)|A blazing fast, multi-protocol download manager. | 极速多协议下载管理器|
|[fluxdown-cli](https://fluxdown.zerx.dev/docs/en/api/cli/)|[0.2.5-rc.2](https://github.com/zerx-lab/FluxDown/releases.atom)|An aria2c-style command-line client for FluxDown. | aria2c 风格的 FluxDown 命令行客户端|
...
|[fnox](https://fnox.jdx.dev/)|[1.31.1](https://fnox.jdx.dev/)|A secrets management tool that works with both encrypted secrets in git and remote cloud providers.|
...
|[fresh-editor](https://github.com/sinelaw/fresh)|[0.4.5](https://github.com/sinelaw/fresh)|A terminal text editor you can just use.|
...
|[gam](https://github.com/GAM-team/GAM)|[7.47.00](https://github.com/GAM-team/GAM)|A command line tool that allows administrators to manage many aspects of their Google Workspace (formerly G Suite / Google Apps) Account.|
...
|[gcx](https://github.com/grafana/gcx)|[0.6.0](https://github.com/grafana/gcx)|A CLI for managing Grafana and Grafana Cloud resources, optimized for agentic usage.|
...
|[gearboy](https://github.com/drhelius/Gearboy)|[3.8.11](https://github.com/drhelius/Gearboy)|A Game Boy / Game Boy Color / Super Game Boy emulator, debugger and embedded MCP server.|
...
|[ghqr](https://microsoft.github.io/ghqr/)|[0.5.1](https://github.com/microsoft/ghqr/releases.atom)|A CLI tool that analyzes GitHub enterprises, organizations, and repositories to ensure compliance with GitHub best practices and security recommendations.|
...
|[github-mcp-server](https://github.com/github/github-mcp-server)|[1.7.0](https://github.com/github/github-mcp-server)|GitHub's official MCP Server.|
...
|[go-jsonschema](https://github.com/omissis/go-jsonschema)|[0.24.0](https://github.com/omissis/go-jsonschema)|A tool to generate Go data types from JSON Schema definitions.|
...
|[gonc](https://github.com/threatexpert/gonc)|[2.6.8](https://github.com/threatexpert/gonc)|Netcat with automated NAT traversal, secure P2P, and advanced features for shell access, file transfer, and network proxying.|
...
|[gost](https://gost.run/)|[3.2.7-nightly.20260726](https://github.com/go-gost/gost/releases.atom)|GO Simple Tunnel - a simple tunnel written in golang.|
...
|[haruna-nightly](https://apps.kde.org/haruna/)|[1939](https://cdn.kde.org/ci-builds/multimedia/haruna/master/windows/)|(Nightly Build) An open source media player built with Qt/QML and libmpv.|
...
|[hcom](https://github.com/aannoo/hcom)|[0.7.24](https://github.com/aannoo/hcom)|A CLI that lets AI coding agents message, watch, and spawn each other across terminals with integration for Claude Code, Codex, Gemini, and more.|
...
|[hoptodesk](https://www.hoptodesk.com/)|[1.46.9](https://raw.githubusercontent.com/hoilc/scoop-juicer/main/manifests/hoptodesk/state.json)|A free and secure remote desktop software to easily screen share, transfer files, and securely manage devices with end-to-end encryption.|
...
|[hypomux](https://github.com/Hypostasis-Cat/HypoMux)|[2.1.2](https://github.com/Hypostasis-Cat/HypoMux)|Windows multi-NIC bandwidth aggregator | 专为 Windows 平台打造的多网卡带宽并发聚合下载加速工具，用于在多连接下载场景中实现更稳定的带宽叠加体验|
...
|[icm](https://github.com/rtk-ai/icm)|[0.10.59](https://github.com/rtk-ai/icm/releases.atom)|Permanent memory for AI agents as a single binary with zero dependencies and native MCP support.|
|[idescriptor](https://idescriptor.github.io)|[0.5.0](https://idescriptor.github.io)|A free, open-source, and cross-platform iDevice management tool written in Rust and Qt.|
...
|[ik-llama-cpp](https://github.com/ikawrakow/ik_llama.cpp)|[b5063-ea062d7](https://github.com/Thireus/ik_llama.cpp/releases.atom)|(Thireus's Build / CUDA 12) ik_llama.cpp is a fork of llama.cpp with better CPU and hybrid GPU/CPU performance.|
|[ik-llama-cpp-cpu](https://github.com/ikawrakow/ik_llama.cpp)|[b5063-ea062d7](https://github.com/Thireus/ik_llama.cpp/releases.atom)|(Thireus's Build / CPU AVX2) ik_llama.cpp is a fork of llama.cpp with better CPU and hybrid GPU/CPU performance.|
|[ik-llama-cpp-cuda-13](https://github.com/ikawrakow/ik_llama.cpp)|[b5063-ea062d7](https://github.com/Thireus/ik_llama.cpp/releases.atom)|(Thireus's Build / CUDA 13) ik_llama.cpp is a fork of llama.cpp with better CPU and hybrid GPU/CPU performance.|
...
|[inngest-cli](https://github.com/inngest/inngest)|[1.38.1](https://github.com/inngest/inngest)|The CLI for Inngest, the durable execution and workflow orchestration platform for serverless step functions and AI workflows.|
...
|[iwaratool](https://github.com/Moeary/IwaraTool)|[0.6](https://github.com/Moeary/IwaraTool)|An Iwara batch downloader featuring a modern Fluent-style UI. | 图形化 Iwara 视频下载器|
...
|[jaguar](https://github.com/toitlang/jaguar)|[1.69.0](https://github.com/toitlang/jaguar)|Jaguar enables live reloading of Toit code when developing for the ESP32, a popular microcontroller.|
...
|[kazumi](https://kazumi.app)|[2.2.3](https://kazumi.app)|基于自定义规则的番剧采集APP，支持流媒体在线观看，支持弹幕，支持实时超分辨率|
...
|[keepassxc-snapshot](https://snapshot.keepassxc.org)|[2.8.0-289425](https://snapshot.keepassxc.org)|(Snapshot Build) Community fork of KeePass|
...
|[ki-editor](https://ki-editor.github.io/ki-editor/)|[20260723-0225-bbceae1](https://github.com/ki-editor/ki-editor/releases/tag/latest)|Multi-cursor structural editor.|
...
|[kmymoney](https://kmymoney.org/)|[5.2-5891](https://kmymoney.org/)|A personal finance manager developed by KDE.|
|[kmymoney-nightly](https://kmymoney.org/)|[5887](https://cdn.kde.org/ci-builds/office/kmymoney/master/windows/)|(Nightly Build) A personal finance manager developed by KDE.|
...
|[kosli](https://github.com/kosli-dev/cli)|[2.34.0](https://github.com/kosli-dev/cli/releases.atom)|A CLI client for reporting DevOps change events to Kosli and querying them.|
...
|[kurrentdb](https://www.kurrent.io/)|[26.1.1](https://nuget.eventstore.com/kurrent-latest/v3/search/query?q=kurrentdb)|A database that's engineered for modern software applications and event-driven architectures.|
...
|[lakefs](https://docs.lakefs.io/)|[1.84.1](https://docs.lakefs.io/)|An open-source tool that transforms your object storage into a Git-like repository.|
...
|[lark-cli](https://github.com/larksuite/cli)|[1.0.77](https://github.com/larksuite/cli)|A command-line tool for Lark/Feishu Open Platform — built for humans and AI Agents.|
...
|[lightnovel-crawler](https://github.com/dipu-bd/lightnovel-crawler)|[4.13.1](https://github.com/dipu-bd/lightnovel-crawler)|An app to download novels from online sources and generate e-books.|
...
|[lisette](https://lisette.run/)|[0.10.0](https://github.com/ivov/lisette/releases.atom)|A little language inspired by Rust that compiles to Go.|
...
|[liteparse](https://github.com/run-llama/liteparse)|[2.9.0](https://github.com/run-llama/liteparse/releases.atom)|A fast, helpful, and open-source document parser.|
...
|[livekit-cli](https://github.com/livekit/livekit-cli)|[2.18.1](https://github.com/livekit/livekit-cli)|The command line interface to LiveKit, an open source platform for developers building realtime media applications.|
...
|[llama-swap](https://github.com/mostlygeek/llama-swap)|[243](https://github.com/mostlygeek/llama-swap)|A light weight, transparent proxy server that provides automatic model swapping to llama.cpp's server.|
...
|[lmms-nightly](https://lmms.io/)|[1.3.0-alpha.1.1022+34aab9f](https://lmms.io/)|(Nightly Build) A free, open source, multiplatform digital audio workstation.|
...
|[lunatranslator](https://github.com/HIllya51/LunaTranslator)|[10.16.1.8](https://github.com/HIllya51/LunaTranslator)|LunaTranslator is a Visual Novel translate tool, support clipboard / OCR/ HOOK, support 40+ translate engines.|
...
|[mago](https://mago.carthage.software/)|[1.45.0](https://github.com/carthage-software/mago/releases.atom)|An extremely fast PHP linter, formatter, and static analyzer, written in Rust.|
...
|[mangayomi](https://github.com/kodjodevf/mangayomi)|[0.8.0](https://github.com/kodjodevf/mangayomi)|An open-source Flutter app for reading manga, novels, and watching animes.|
...
|[mesheryctl](https://meshery.io/)|[1.0.63](https://meshery.io/)|Command-line utility for Meshery, the cloud native management plane.|
...
|[microsoft-safety-scanner](https://learn.microsoft.com/en-us/defender-endpoint/safety-scanner-download)|[1.455.364.0](https://learn.microsoft.com/en-us/defender-endpoint/safety-scanner-download)|A scan tool designed to find and remove malware from Windows computers.|
...
|[morphe-desktop](https://github.com/MorpheApp/morphe-desktop)|[1.12.0](https://github.com/MorpheApp/morphe-desktop)|Morphe Desktop is a command-line and GUI application that uses Morphe Patcher to patch Android apps.|
...
|[mouser](https://github.com/TomBadash/Mouser)|[3.7.1](https://github.com/TomBadash/Mouser)|A lightweight, open-source, fully local alternative to Logitech Options+ for remapping Logitech HID++ mice.|
...
|[mql](https://github.com/mondoohq/cnquery)|[13.30.1](https://github.com/mondoohq/cnquery/releases.atom)|A cloud-native tool for querying your entire infrastructure.|
...
|[netcatty](https://netcatty.app/)|[1.1.73](https://github.com/binaricat/Netcatty/releases.atom)|A beautiful, feature-rich SSH workspace built with Electron, React, and xterm.js.|
...
|[netsurf-nightly](https://www.netsurf-browser.org/)|[7441](https://ci.netsurf-browser.org/builds/windows/LATEST)|A free, open source web browser.|
...
|[nipaplay](https://github.com/MCDFsteve/NipaPlay-Reload)|[1.11.2](https://github.com/MCDFsteve/NipaPlay-Reload)|NipaPlay-Reload 是一个现代化的跨平台视频播放器，集成了弹幕显示、多格式字幕支持、多音频轨道切换，新番查看等功能|
...
|[openspeedy](https://github.com/game1024/OpenSpeedy)|[3.3.7](https://github.com/game1024/OpenSpeedy/releases.atom)|An open-source game speed modifier / 一款开源的游戏变速器|
...
|[oxen](https://oxen.ai/)|[0.52.4](https://oxen.ai/)|CLI for Oxen, a lightning fast data version control system for structured and unstructured machine learning datasets.|
...
|[oxideterm](https://oxideterm.app/)|[2.0.12](https://oxideterm.app/)|All-in-one terminal workspace — local shells, SSH, SFTP, remote IDE, AI agent, and file manager in a single native binary.|
...
|[pdf-oxide](https://oxide.fyi/)|[0.3.75](https://oxide.fyi/)|A command-line tool for PDF text extraction, markdown conversion, search, merge, split, image extraction, and more.|
...
|[pitchfork](https://pitchfork.jdx.dev/)|[2.19.0](https://pitchfork.jdx.dev/)|A devilishly good process manager for developers.|
...
|[pixpin-beta](https://pixpinapp.com/)|[3.4.2.2](https://api.viewdepth.cn/app_info?app_id=pixpin&update_type=1&sys=win&ver=1.8.2.0)|（测试版）功能强大使用简单的截图/贴图工具，帮助你提高效率|
...
|[prek](https://github.com/j178/prek)|[0.4.11](https://github.com/j178/prek)|Better `pre-commit`, re-engineered in Rust.|
...
|[project-graph](https://github.com/LiRenTech/project-graph)|[4.1.1](https://github.com/LiRenTech/project-graph)|An open-source project that aims to provide a next-generation node diagram tool for visual thinking.|
...
|[pscale](https://github.com/planetscale/cli)|[0.307.0](https://github.com/planetscale/cli)|The CLI for PlanetScale Database.|
...
|[qodercli](https://qoder.com/cli)|[1.1.5](https://download.qoder.com/qodercli/channels/manifest.json)|Qoder AI CLI tool - Terminal-based AI assistant for code development.|
|[qoderclicn](https://qoder.com.cn/cli)|[1.1.5](https://static.qoder.com.cn/qoder-cli-cn/channels/manifest.json)|(国内版) Qoder CLI AI 编程助手，将强大的 AI 编程能力直接带入你的终端|
...
|[quincy](https://github.com/quincy-rs/quincy)|[3.0.0](https://github.com/quincy-rs/quincy)|A VPN client and server implementation using the QUIC protocol with support for pre-quantum, hybrid and post-quantum cryptography.|
...
|[rainfrog](https://github.com/achristmascarl/rainfrog)|[0.4.1](https://github.com/achristmascarl/rainfrog)|A database management TUI.|
...
|[rapidraw](https://github.com/CyberTimon/RapidRAW)|[1.6.0](https://github.com/CyberTimon/RapidRAW)|A beautiful, non-destructive, and GPU-accelerated RAW image editor built with performance in mind.|
...
|[ratex](https://ratex.lites.dev/)|[0.1.13](https://ratex.lites.dev/)|A KaTeX-compatible math rendering engine in pure Rust — no JavaScript, no WebView, no DOM.|
...
|[rattler-build](https://github.com/prefix-dev/rattler-build)|[0.70.1](https://github.com/prefix-dev/rattler-build)|A universal Conda package builder (like conda-build but faster).|
...
|[redis_exporter](https://github.com/oliver006/redis_exporter)|[1.88.0](https://github.com/oliver006/redis_exporter)|A Prometheus exporter for Redis metrics.|
...
|[redpanda-connect](https://docs.redpanda.com/redpanda-connect/about/)|[4.102.0](https://docs.redpanda.com/redpanda-connect/about/)|Redpanda Connect (Originally Benthos) is a high performance and resilient stream processor, able to connect various sources and sinks|
...
|[redumper](https://github.com/superg/redumper)|[735](https://github.com/superg/redumper/releases.atom)|A low level CD dumper utility.|
...
|[rerun-cli](https://rerun.io/)|[0.35.0](https://rerun.io/)|CLI for Rerun, the time-aware multimodal data stack and visualizations.|
...
|[riba2534-feishu-cli](https://github.com/riba2534/feishu-cli)|[1.37.1](https://github.com/riba2534/feishu-cli)|飞书开放平台命令行工具 — Markdown 与飞书文档双向转换，AI Agent 的飞书操控引擎|
...
|[rigaya-nvenc](https://github.com/rigaya/NVEnc)|[9.26](https://github.com/rigaya/NVEnc/releases.atom)|Investigate performance and image quality of HW encoder (NVENC) of NVIDIA.|
|[rigaya-qsvenc](https://github.com/rigaya/QSVEnc)|[8.23](https://github.com/rigaya/QSVEnc)|Investigate performance and image quality of HW encoder (QSV) of Intel.|
|[rigaya-vceenc](https://github.com/rigaya/VCEEnc)|[9.09](https://github.com/rigaya/VCEEnc)|An AMD VCE hardware codec based command line video encoder.|
...
|[risoheditor](https://katahiromz.web.fc2.com/re/en/)|[6.0.7](https://katahiromz.web.fc2.com/re/en/)|RisohEditor is a free Win32 resource editor.|
...
|[rmux](https://rmux.io/)|[0.9.1](https://rmux.io/)|An async, typed terminal multiplexer engine written in Rust.|
...
|[rpk](https://docs.redpanda.com/current/get-started/rpk/)|[26.1.14](https://docs.redpanda.com/current/get-started/rpk/)|Redpanda Keeper (rpk) is a single binary application that provides a way to interact with your Redpanda clusters from the command line.|
...
|[ruqola-nightly](https://apps.kde.org/ruqola/)|[12984](https://cdn.kde.org/ci-builds/network/ruqola/master/windows/)|(Nightly Build) A Rocket.Chat client developed by KDE.|
...
|[rustfs](https://github.com/rustfs/rustfs)|[1.0.0-beta.11](https://github.com/rustfs/rustfs/releases.atom)|A high-performance, distributed object storage system built in Rust.|
|[rustfs-cli](https://github.com/rustfs/cli)|[0.1.30](https://github.com/rustfs/cli/releases.atom)|A S3-compatible command-line client written in Rust.|
...
|[sing-box-beta](https://sing-box.sagernet.org)|[1.14.0-beta.2](https://github.com/SagerNet/sing-box/releases.atom)|(Pre-release) The universal proxy platform.|
...
|[sing-geosite](https://sing-box.sagernet.org/configuration/route/geosite/)|[20260724024523](https://sing-box.sagernet.org/configuration/route/geosite/)|Geosite database for sing-box.|
|[sing-geosite-rule-set](https://sing-box.sagernet.org/configuration/rule-set/)|[20260724-a995857](https://api.github.com/repos/SagerNet/sing-geosite/branches/rule-set)|Geosite rule set for sing-box.|
...
|[snarkos](https://github.com/ProvableHQ/snarkOS)|[4.8.1](https://github.com/ProvableHQ/snarkOS/releases.atom)|A decentralized operating system for zero-knowledge applications.|
...
|[speakeasy](https://speakeasy.com/)|[1.791.0](https://speakeasy.com/)|Generate client SDKs in popular languages from your OpenAPI spec with Speakeasy.|
...
|[stable-diffusion-cpp](https://github.com/leejet/stable-diffusion.cpp)|[b796-2d0385b](https://github.com/leejet/stable-diffusion.cpp/releases.atom)|(CPU Backend) stable-diffusion.cpp enables inference of Stable Diffusion and Flux in pure C/C++.|
|[stable-diffusion-cpp-cuda](https://github.com/leejet/stable-diffusion.cpp)|[b796-2d0385b](https://github.com/leejet/stable-diffusion.cpp/releases.atom)|(CUDA 12 Backend) stable-diffusion.cpp enables inference of Stable Diffusion and Flux in pure C/C++.|
|[stable-diffusion-cpp-rocm](https://github.com/leejet/stable-diffusion.cpp)|[b796-2d0385b](https://github.com/leejet/stable-diffusion.cpp/releases.atom)|(AMD ROCm/HIP Backend) stable-diffusion.cpp enables inference of Stable Diffusion and Flux in pure C/C++.|
|[stable-diffusion-cpp-vulkan](https://github.com/leejet/stable-diffusion.cpp)|[b796-2d0385b](https://github.com/leejet/stable-diffusion.cpp/releases.atom)|(Vulkan Backend) stable-diffusion.cpp enables inference of Stable Diffusion and Flux in pure C/C++.|
...
|[sumatrapdf-plus](https://github.com/dengxibo/sumatrapdf-plus)|[3.7.18](https://github.com/dengxibo/sumatrapdf-plus)|Unofficial fork of SumatraPDF, a document reader (PDF, EPUB, MOBI, and more) with improvements for Chinese ebooks, offline lookup, themes, and smart PDF dark mode.|
...
|[svg-hush](https://github.com/cloudflare/svg-hush)|[0.9.6](https://crates.io/api/v1/crates/svg-hush?include=default_version)|Make it safe to serve untrusted SVG files.|
...
|[talhelper](https://budimanjojo.github.io/talhelper)|[3.1.15](https://budimanjojo.github.io/talhelper)|A tool to help creating Talos kubernetes cluster.|
...
|[tencent-qqmail-agently-cli](https://agent.qq.com/)|[1.0.11](https://registry.npmjs.org/@tencent-qqmail/agently-cli/latest)|QQ 邮箱 Agent Mail 命令行工具，支持发送、回复、转发、搜索、读取邮件、下载附件、管理收件箱|
...
|[testkube](https://testkube.io/)|[2.12.0](https://testkube.io/)|Kubernetes-native testing framework for test execution and orchestration.|
...
|[tgpt](https://github.com/aandrew-me/tgpt)|[2.12.0](https://github.com/aandrew-me/tgpt)|A CLI tool that allows you to use AI chatbot in your Terminal without requiring API keys.|
...
|[throne](https://github.com/throneproj/Throne)|[1.2.1](https://github.com/throneproj/Throne/releases.atom)|A cross-platform GUI proxy utility (Empowered by sing-box)|
...
|[timoni](https://timoni.sh/)|[0.27.1](https://timoni.sh/)|A package manager for Kubernetes, powered by CUE and inspired by Helm.|
...
|[tokensave](https://github.com/aovestdipaperino/tokensave)|[7.8.0](https://github.com/aovestdipaperino/tokensave/releases.atom)|A comprehensive code intelligence MCP server for AI coding agents.|
|[tokscale](https://github.com/junhoyeo/tokscale)|[4.7.0](https://registry.npmjs.org/@tokscale/cli/latest)|Track token usage across AI coding agents from your terminal.|
...
|[touchhle-nightly](https://touchhle.org/)|[b2303](https://github.com/touchHLE/touchHLE/actions/workflows/touchHLE_release.yml?query=event%3Apush+is%3Asuccess+branch%3Atrunk)|(Preview Builds) A high-level emulator for iPhone OS apps.|
...
|[tty7](https://github.com/l0ng-ai/tty7)|[26.7.4](https://github.com/l0ng-ai/tty7)|A GPU-rendered, daemon-backed terminal in pure Rust.|
...
|[ty](https://github.com/astral-sh/ty)|[0.0.63](https://github.com/astral-sh/ty/releases.atom)|An extremely fast Python type checker and language server, written in Rust.|
...
|[upcloud-cli](https://github.com/UpCloudLtd/upcloud-cli)|[3.35.0](https://github.com/UpCloudLtd/upcloud-cli)|upctl provides a command-line interface to UpCloud services.|
...
|[usage](https://usage.jdx.dev/)|[4.0.0](https://usage.jdx.dev/)|A specification for CLIs.|
...
|[vercel](https://vercel.com/)|[57.0.0](https://github.com/vercel/vercel/releases.atom)|Native CLI for Vercel, a unified platform for building modern applications.|
...
|[videoduplicatefinder](https://github.com/0x90d/videoduplicatefinder)|[3.0-444-e17ccc5](https://github.com/0x90d/videoduplicatefinder/actions/workflows/releases.yml?query=event%3Apush+is%3Asuccess+branch%3Amaster)|A cross-platform software to find duplicated video (and image) files on hard disk based on similarity.|
|[videoduplicatefinder-cli](https://github.com/0x90d/videoduplicatefinder)|[3.0-444-e17ccc5](https://github.com/0x90d/videoduplicatefinder/actions/workflows/releases.yml?query=event%3Apush+is%3Asuccess+branch%3Amaster)|(CLI Version) A cross-platform software to find duplicated video (and image) files on hard disk based on similarity.|
|[videofusion](https://271374667.github.io/VideoFusion/)|[1.12.5](https://271374667.github.io/VideoFusion/)|一站式批量化视频处理工具|
|[vii3](https://github.com/vvyoko/Vii3)|[3.3.22](https://github.com/vvyoko/Vii3)|A high-performance frameless image viewer based on Avalonia, delivering ultra-smooth switching experience, comprehensive format support.|
...
|[volcengine-cli](https://www.volcengine.com/docs/83927/1176799)|[1.0.52](https://www.volcengine.com/docs/83927/1176799)|通过命令行调用火山引擎云服务的OpenAPI，便于自动、高效管理云上资源|
...
|[vtracer](https://github.com/visioncortex/vtracer)|[1.0.0-alpha.1](https://github.com/visioncortex/vtracer/releases.atom)|An open source software to convert raster images (like jpg & png) into vector graphics (svg).|
...
|[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)|[2026.07.26.1327-b8412a2](https://github.com/xpzouying/xiaohongshu-mcp/releases.atom)|MCP for 小红书 / xiaohongshu.com|
...
|[yabasanshiro](https://www.yabasanshiro.com/)|[1.20.30](https://www.yabasanshiro.com/download)|Yaba Sanshiro is a Sega Saturn emulator.|
...
|[yandex-cloud-cli](https://cloud.yandex.ru/docs/cli/)|[1.20.0](https://storage.yandexcloud.net/yandexcloud-yc/release/stable)|Command line interface that helps you interact with Yandex Cloud services.|
...
|[zedis](https://github.com/vicanso/zedis)|[0.6.4](https://github.com/vicanso/zedis)|A high-performance, GPU-accelerated Redis client built with Rust and GPUI.|
...
|[zotero-beta](https://www.zotero.org/)|[10.0-beta.16](https://www.zotero.org/)|Open-source reference management software to manage bibliographic data and related research materials.|
